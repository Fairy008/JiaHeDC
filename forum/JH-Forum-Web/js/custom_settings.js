...
define(function(){
    ...
    var custom_settings = {
         ...
         * 公共的title配置
         */
        public_title:"珈和遥感",  //login.html 、main.html、index.html 都有配置 title 名称
        ...
        login_left_top_logo_pic:"images/public/logo4.png",
    ...
    //login.html 最下面版权信息
        ...
        main_left_top_logo_pic:"images/public/logo1.png",
        ...
        //任务类型 数据集
        task_types : ['1801','1802','1803'],
        //是否新任务,修改该值，替换新任务 ， 1是新版本，0是旧版本
        isNewTask : 1,
    };
