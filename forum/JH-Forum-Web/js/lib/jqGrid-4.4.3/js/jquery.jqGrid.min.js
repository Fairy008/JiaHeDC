...
"eq";0<=l&&o[l].searchoptions&&o[l].searchoptions.sopt?x=o[l].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(x=b.sopt[0]);s={groupOp:"AND",rules:[{field:n,op:x,data:""}]}}k=!1;b.tmplNames&&b.tmplNames.length&&(k=!0,g=b.tmplLabel,g+="<select class='ui-briefing'>",g+="<option value='default'>Default</option>",a.each(b.tmplNames,function(a,b){g=g+("<option value='"+a+"'>"+b+"</option>")}),g+="</select>");f="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+i+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+
