...
import com.jh.forum.bbs.util.HttpUtil;
...
/**
 * @Description：
 * @version<1> 2019-05-15 mason : Created.
 */
@RestController
@PropertySource(value = {"classpath:config.properties"})
@RequestMapping("/nolog/weChat")
public class NologWeChatController {
    ...
    //参数的有效时间,单位是秒(s),微信官方设置的超时时间是7200秒
    private Long tokenExpireTime = 7000L;
    private Long ticketExpireTime = 7000L;

    //获取微信参数
    @GetMapping("/getWechatParam")
    @ResponseBody
    public Map<String, String> getWechatParam(@RequestParam String url){
        //当前时间
