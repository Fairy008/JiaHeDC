  ...
  PDFFindController.prototype = {
    ...
    nextPageMatch: function PDFFindController_nextPageMatch() {
      if (this.resumePageIdx !== null) {
        console.log('There can only be one pending page.');
      }
      do {
    ...
    if (scale > 0) {
      ...
      switch (value) {
        ...
        case 'auto':
          ...
          break;
        default:
          console.log('pdfViewSetScale: \'' + value +
...
var PageView = function pageView(container, id, scale,
    ...
    if (this.textLayer) {
      ...
      switch (textAbsRotation) {
        ...
        case 270:
          ...
          break;
        default:
          console.log('Bad rotation value.');
          break;
      }
  ...
  this.draw = function pageviewDraw(callback) {
    ...
    if (this.renderingState !== RenderingStates.INITIAL) {
      console.log('Must be in new state before drawing');
    }
    ...
    convertMatches: function TextLayerBuilder_convertMatches(matches) {
      ...
      for (var m = 0, len = matches.length; m < len; m++) {
        ...
        if (i === bidiTexts.length) {
          console.log('Could not find a matching mapping');
        }
