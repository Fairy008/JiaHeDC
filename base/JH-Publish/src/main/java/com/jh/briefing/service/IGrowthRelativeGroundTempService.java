 ...
 */
public interface IGrowthRelativeGroundTempService extends IBaseService<GrowthRelativeGroundTempParam,GrowthRelativeGroundTemp,Integer> {
     ...
     * @return
     */
    ResultMessage saveGrowthRelativeGroundTemp(GrowthRelativeGroundTemp growthRelativeGroundTemp);
     ...
     * @version <1> 2018-05-23 lxy： Created.
     */
    ResultMessage saveBatchGrowthRelativeGroundTemp(List<GrowthRelativeGroundTempParam> growthConditions);
     ...
     * @return
     */
    ResultMessage updateGrowthRelativeGroundTemp(GrowthRelativeGroundTemp growthRelativeGroundTemp);
     ...
     * @version <1> 2018-04-17 lxy： Created.
     */
    PageInfo<GrowthRelativeGroundTempParam> findByPage(GrowthRelativeGroundTempParam growthRelativeGroundTempParam);
     ...
     */
    List<GrowthRelativeGroundTempParam> queryGrowthRelativeTemp(Integer growthId);
