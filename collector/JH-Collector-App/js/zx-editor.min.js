...
! function(e, t) {
	...
	return function(e) {
		...
		(e.exports = i(3)(!1)).push([e.i,
			...
			r(i(9)) + ")}}.zxeditor-container .zxeditor-toolbar-wrapper dl dd.__emoji i{background-image:url(" + r(i(10)) +
			...
			r(i(11)) + ")}}.zxeditor-container .zxeditor-toolbar-wrapper dl dd.__text i{background-image:url(" + r(i(12)) +
			...
			r(i(13)) + ")}}.zxeditor-container .zxeditor-toolbar-wrapper dl dd.__link i{background-image:url(" + r(i(14)) +
		...
		function u(e, t) {
			for (var i = 0; i < e.length; i++) {
				...
				if (n) {
					...
					for (; a < r.parts.length; a++) n.parts.push(x(r.parts[a], t))
				} else {
					var l = [];
					for (a = 0; a < r.parts.length; a++) l.push(x(r.parts[a], t));
					o[r.id] = {
						id: r.id,
						refs: 1,
						parts: l
		...
		function f(e, t) {
			for (var i = [], r = {}, n = 0; n < e.length; n++) {
				...
				r[a] ? r[a].parts.push(l) : i.push(r[a] = {
					id: a,
					parts: [l]
				})
			}
		...
		function h(e, t) {
			...
			var r = d[d.length - 1];
			if ("top" === e.insertAt) r ? r.nextSibling ? i.insertBefore(t, r.nextSibling) : i.appendChild(t) : i.insertBefore(
				t, i.firstChild), d.push(t);
		...
		e.exports = function(e) {
			...
			return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e, t) {
				...
				return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/)/i.test(o) ? e : (n = 0 === o.indexOf("//") ? o : 0 ===
					o.indexOf("/") ? i + o : r + o.replace(/^\.\//, ""), "url(" + JSON.stringify(n) + ")")
			})
		}
	}, function(e, t) {
		...
		var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			n = {
				...
				rgbToHex: function(e) {
					var t = "";
					return /rgb.*?\((\d+)\D+?(\d+)\D+?(\d+)/.test(e) && (t += this.toHex(RegExp.$1), t += this.toHex(RegExp.$2),
						t += this.toHex(RegExp.$3)), t ? "#" + t : e
				},
				isEmpty: function(e) {
			...
			s = {
				...
				addEvent: function(e, t, i) {
					...
					if (e && t && i)
						if (e.length)
							for (var n = 0; n < e.length; n++) c(e[n], t, i, r);
						else c(e, t, i, r)
				},
				removeEvent: function(e, t, i) {
					...
					if (e && t && i)
						if (e.length)
							for (var n = 0; n < e.length; n++) d(e[n], t, i, r);
						else d(e, t, i, r)
				},
				createElm: function() {
				...
				changeTagName: function(e, t) {
					...
					var i = s.createElm(t),
						...
						c = "";
					"ul" === r ? n.slice(e.children).forEach(function(e) {
						c += e.innerHTML
					}) : c = "blockquote" === r ? e.innerText : e.innerHTML;
					return "blockquote" === t ? c = '<p style="color: inherit">' + c + "</p>" : "ul" === t && (c =
						'<li style="color: inherit">' + c + "</li>"), o && (i.className = o), a && (i.id = a), l && i.setAttribute(
						"style", l), i.innerHTML = c, e = null, i
				},
				closest: function(e, t) {
					for (var i = t.matches || t.webkitMatchesSelector || t.mozMatchesSelector || t.msMatchesSelector; t && !i.call(
							t, e);) t = t.parentNode;
					return t
				},
				...
				queryAll: function(e) {
					...
					if (/^#\w+$/.test(e))(r = t.getElementById(e)) && i.push(r);
						...
						if (/^\.(\w+)$/.test(e))
							...
							for (var d = e.toUpperCase(), p = 0; p < a; p++)(r = o[p]).nodeName === d && i.push(r)
					}
					return i
				},
				...
				maxZIndex: function() {
					for (var e = l.getElementsByTagName("*"), t = void 0, i = void 0, r = void 0, o = [], a = 0; a < e.length; a++)
						1 === (t = e[a]).nodeType && "static" !== (i = s.getStyle(t) || {}).position && (r = n.int(i.zIndex)) > 0 &&
						o.push(r);
				...
				insertToRangeElm: function(e, t, i, r) {
					var n = void 0;
					if (s.isEmptyInner(t, !0) ? ((n = t).innerHTML = "", n.appendChild(e)) : ((n = s.createElm("p")).appendChild(
							e), s.insertAfter(t, n)), i && (n.className = i), r) {
						var o = s.createElm("i", {
							class: "__remove"
						});
				...
				getScroll: function(e) {
					...
					return t = null !== a.pageYOffset ? {
						...
						left: o.body.scrollLeft,
						top: o.body.scrollTop
					}, "left" === e || "top" === e ? t[e] : t
				},
		...
		function d(e, t, i, r) {
			e.removeEventListener ? e.removeEventListener(t, i, r) : e.detachEvent ? e.detachEvent(t, i) : e["on" + t] =
				null
		}
		var p = s,
			u = {
				broadcast: {},
				on: function(e, t) {
					e && "string" == typeof e && t && "function" == typeof t && (this.broadcast[e] || (this.broadcast[e] = []),
						this.broadcast[e].push(t))
				},
				emit: function(e) {
					var t = this.broadcast[e];
					if (t)
						for (var i = Array.prototype.slice.call(arguments, 1), r = 0; r < t.length; r++) try {
							t[r].apply(null, i)
						} catch (t) {
							this.emit("error", {
								code: 1,
		...
		var b = function() {
				...
				return h(e, [{
					...
					value: function(e, t, i) {
						...
						if (t && "object" === (void 0 === t ? "undefined" : f(t)) && (t = JSON.stringify(t)), !t || "{}" === t ||
							"[]" === t) return this.remove(e), !1;
						var r = m(i);
						try {
							r.setItem(e, t)
						} catch (e) {
		...
		var v = function() {
				function e(t) {
					! function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), this.$content = t, this.selection = null, this.range = null, this.offset = 0, this.timer = null,
						this.init()
				}
				return x(e, [{
					key: "init",
					...
					value: function(e, t) {
						var i = this;
						null === this.selection ? this.init() : this.selection.removeAllRanges(), this.offset = n.int(t), e &&
							this.range.setStart(p.getTextNode(e), this.offset), this.range.collapse(!0), this.timer && (clearTimeout(
								this.timer), this.timer = null), this.timer = setTimeout(function() {
					...
					value: function() {
						...
						return y(this.range.endContainer, this.$content) || this.$content.lastElementChild || p.insertParagraph(
							this.$content)
					}
				}]), e
			}(),
		...
		var A = {
			...
			k = function() {
				function e() {
					...
					! function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), this.visible = !1, this.opts = Object.assign({}, A, t), this.ids = [], this.$loadings = [], this._init(),
						this.version = "2.5.3"
				}
				return w(e, [{
					key: "_init",
					...
					value: function(e, t) {
						...
						o.push({
							...
							child: [{
								...
								attrs: {
									class: "__confirm",
									style: i.confirmBtnColor ? "color:" + i.confirmBtnColor : ""
								},
								child: "确定"
							}]
						}), this._createDialog("alert", r, o), "function" == typeof t && this.on(r, t)
					}
				}, {
					key: "confirm",
					value: function(e, t) {
						...
						o.push({
							...
							child: [{
								...
								attrs: {
									class: "__cancel",
									style: i.cancelBtnColor ? "color:" + i.cancelBtnColor : ""
								},
								child: "取消"
							}, {
								tag: "span",
						...
						}), this._createDialog("confirm", r, o), "function" == typeof t && this.on(r, t)
					}
				}, {
					key: "loading",
					value: function(e) {
					...
					key: "removeLoading",
					value: function() {
						for (var e = void 0; this.$loadings.length;)(e = this.$loadings.pop()).parentNode && e.parentNode.removeChild(
							e);
						p.unlock()
					}
				}, {
		...
		k.prototype.on = u.on, k.prototype.emit = u.emit, k.prototype.off = u.off;
		var E = k,
			z = 48,
			R = {
				autoSave: 0,
		...
		function T(e) {
			...
			p.addEvent(i, "click", function(r) {
				r.stopPropagation(), u.emit("click", i, r), e.emojiModal.hide(), e.textstyleModal.hide();
				var n = r.target,
					o = n.nodeName;
				if ("A" === o && r.preventDefault(), "I" === o && n.className.indexOf("__remove") >= 0) return r.preventDefault(),
					void
				function(r) {
					var n = y(r, i),
						o = (n ? n.className : "").replace(/child-node-is-(\w+)/, "$1"),
						a = S[o];
					e.emit("debug", "Delete " + a), e.dialog.confirm("您确定要删除" + a + "吗？", function(i) {
						if (i) {
							if (n) {
								u.emit("remove-attach", n, o);
								var r = n.nextElementSibling || n.previousElementSibling;
								n.parentNode.removeChild(n), t.setRange(r, 0)
							}
							u.emit("change", "content", e)
						}
						n = null
					})
				}(n);
				r.currentTarget === i && (! function() {
					if (p.isEmptyInner(i)) {
						var r = p.createElm("p");
						r.innerHTML = "<br>", i.appendChild(r), r.focus(), u.emit("change", "content", e), e.$cursorElm = r
				...
				8 === t.keyCode && (e.options.disableBackspaceDelete && function(t) {
					var r = void 0,
						n = void 0;
					try {
						r = y(e.$cursorElm, i), n = r.previousElementSibling
					} catch (t) {}
					if (!n) return;
					(p.query("a", n) || p.query("img", n) || p.query("video", n) || p.query("audio", n)) && 0 === e.cursor.offset &&
						t.preventDefault()
				}(t), M(i) && t.preventDefault())
			}), p.addEvent(i, "focus", function(e) {
				u.emit("focus", i), C(i)
			}), p.addEvent(i, "blur", function(r) {
				u.emit("blur", i), e.$cursorElm = t.getRange(),
					function(e) {
						n.isEmpty(e.innerText) && !p.query("img", e) ? p.addClass("is-empty", e) : C(e)
					}(i), e.$cursorElm && !e.$cursorElm.innerHTML && (e.$cursorElm.innerHTML = "<br>"),
					function() {
						var t = y(e.$cursorElm, i);
						if (t) {
							var r = t.className;
							if (r) {
			...
			}), p.addEvent(i, "keyup", function(i) {
				e.$cursorElm = t.getRange(), e.checkCursorPosition(), u.emit("change", "content", e)
			}, !1), p.addEvent(i, "paste", function(t) {
				t.preventDefault();
				...
				if (r) {
					...
					a && function() {
						var t = function(t) {
							...
							c = void 0,
							d = void 0;
						for (c = 0; c < r; c++) d = a[c], /^text\/plain/.test(d.type) ? d.getAsString(function(e) {
							t(e)
						}) : t("")
					}()
				}
		...
		var U = {
			...
			B = function() {
				function e() {
					...
					! function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), this.opts = Object.assign({}, U, t), this.height = n.int(this.opts.height), this.visible = t.visible,
						this.init(this.opts)
				}
				return N(e, [{
					key: "init",
					value: function(e) {
						...
						if (t && p.isHTMLElement(t)) {
							...
							this.$modal = p.createVdom(a), t.appendChild(this.$modal), this.$switch = p.query(".__switch", this.$modal),
								this.$body = p.query(".zxeditor-modal-body", this.$modal), this._initEvent()
						} else e.onError({
					...
					value: function() {
						...
						p.addEvent(this.$modal, "click", function(e) {
							...
							!0, p.lock(e)
						}), p.addEvent(t, "touchmove", function(e) {}), p.addEvent(t, "touchend", function(t) {
							!1;
		...
		function Y(e) {
			...
			var i = new B({
				...
				onShow: function() {
					e.emit("bottom-modal", {
						...
						show: !0,
						height: i.height
					}), e.resetContentPostion(i.height), e.checkCursorPosition()
				},
				onHide: function() {
					e.emit("bottom-modal", {
						type: "emoji",
			...
			e.emojiModal = i, p.addEvent(i.$body, "click", function(t) {
				var i = t.target;
				"I" === i.nodeName && function(t) {
					var i = e.cursor.offset;
					try {
						e.$cursorElm.innerHTML = p.insertStr(e.$cursorElm.innerText, t, i), e.cursor.setRange(e.$cursorElm, i + 2),
		...
		function O(e) {
						...
						e.emit("bottom-modal", {
							...
							function() {
								...
								c.forEach(function(e) {
									var t = p.data(e, "color");
									t === i ? p.addClass("active", e) : p.removeClass("active", e)
								}), e.cursor.setRange()
							}(), e.resetContentPostion(i.height), e.checkCursorPosition()
					},
					onHide: function() {
			...
			function l(t) {
				var i = t.currentTarget.getAttribute("data-style").split(":"),
					r = i[0];
				e.$cursorElm.style[r] === i[1] ? e.$cursorElm.style[r] = "" : e.$cursorElm.style[r] = i[1], e.cursor.setRange()
			}
			o && function() {
			...
			s && p.addEvent(c, "click", function(t) {
				var i = t.currentTarget,
					r = p.data(i, "color");
				e.$cursorElm.style.color = r, p.addClass("active", i), (p.siblings(i, "active") || []).forEach(function(e) {
			...
			d && p.addEvent(u, "click", function(t) {
				var i = t.currentTarget;
				if (p.query(".checked", i)) return;
				f(i), (p.siblings(i) || []).forEach(function(e) {
						h(e)
					}), r = i, n = p.data(r, "tag"), o = p.changeTagName(e.$cursorElm, n), e.$content.replaceChild(o, e.$cursorElm),
					e.$cursorElm = o, e.cursor.setRange(e.$cursorElm);
				var r, n, o
			}), p.addEvent(i.$switch, "click", function(e) {
				i.hide()
			})
		}
		var D = ["pic", "emoji", "text", "link"],
		...
		function Z(e) {
			...
			e.$toolbar = p.createVdom(r), e.$editor.appendChild(e.$toolbar),
				function(e) {
					var t = p.query("dl", e),
						i = t.children;
					if (!i[0]) return;
			...
			o.length && p.addEvent(o, "click", function(t) {
				var i = t.currentTarget,
					r = p.data(i, "on"),
					n = p.data(i, "name");
				switch (e.emit("debug", "toolbarClick:", r), n) {
					...
					case "text":
						...
						break;
					case "link":
						e.broadcast[r] ? e.emit(r, function(t, i) {
							e.addLink(t, i)
			...
			var a = function() {
				...
				return e.$wrapper.appendChild(t), p.addEvent(t, "change", l), p.addEvent(t, "click", function(e) {
					e.target.value = ""
				}), t
			}();
			...
			function l(t) {
				...
				var i = this.files,
					r = n.slice(i);
				e.emit("debug", "选中的文件", r), e.filesToBase64(r, {
					width: 640
				}, function(t, i) {
		...
		var P = ["img", "audio", "video"];

		function L(e) {
			var t = void 0,
				i = void 0;
			if (!/^data:(\w+\/\w+);base64,(.+)/.test(e)) return console.error('toBlobData(data), "' + e +
				'" is not base64 data!'), null;
		...
		function V(e, t) {
			...
			return i.width = t.cw, i.height = t.ch, i.getContext("2d").drawImage(e, t.sx, t.sy, t.sw, t.sh, 0, 0, i.width, i
				.height), i
		}
		...
		var K = function() {
			function e(t, i) {
				if (function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), !(this instanceof e)) throw new Error(
			...
			return W(e, [{
				...
				value: function(e, t) {
					var i;
					this.version = "2.5.3", this.broadcast = u.broadcast,
						function(e, t, i) {
							...
							}), t && "string" == typeof t || n.err("selector is '" + t + "', is not valid"), e.$wrapper = p.query(
								t), null === e.$wrapper && n.err("Cann't found '" + t + "' Node in document!");
							var r = Object.assign({}, R, i);
							e.id = n.randStr(), e.dialog = new E, e.on("loading", function(t) {
									e.dialog.loading(t)
								}), e.on("removeLoading", function(t) {
									e.dialog.removeLoading()
								}), e.options = r, e.toolbarHeight = z, e.saveTimer = null, i.autoSave > 0 && e.autoSave(n.int(i.autoSave)),
								e.storage = new b;
							var o = "",
								a = n.int(r.padding),
							...
							var s = {
								tag: "div",
								attrs: {
									class: "zxeditor-container" + (r.fixed ? " fixed" : "")
								},
								child: [{
									tag: "div",
									attrs: {
							...
							e.$editor = p.createVdom(s), e.$content = p.query(".zxeditor-content-wrapper", e.$editor), r.showToolbar &&
								e.resetContentPostion(r.bottom + z), e.$wrapper.appendChild(e.$editor),
								function(e) {
									var t = e.storage.get("content");
									t && e.setContent(t)
								}(e), e.cursor = new v(e.$content), e.$cursorElm = e.cursor.getRange()
						}(this, e, t), Z(this), Y(this), O(this),
						function(e) {
							var t = {
								tag: "div",
								attrs: {
							...
							}, !1), p.addEvent(r, "click", function(t) {
								e.$link.style.display = "none"
							}, !1), p.addEvent(o[0], "keyup", function(e) {
								var t = o[0].value;
								n.isHttpUrl(t) && p.hasClass("disabled", i) && p.removeClass("disabled", i)
							}, !1)
						}(this), T(this), (i = this).keyboard = {
							height: 0
						}, i.setKeyboard = function(e) {
							var t = !1;
							if (n.isObject(e))
								for (var r in e) e.hasOwnProperty(r) && (i.keyboard[r] = e[r], t = !0);
							t && (i.resetContentPostion(i.keyboard.height, i.toolbarHeight), u.emit("message", {
				...
				value: function(e, t) {
					...
					if (e) {
						t = t || e.nodeName.toLowerCase(), this.$cursorElm = p.insertToRangeElm(e, this.$cursorElm,
							"child-node-is-" + t, r), this.cursor.setRange(this.$cursorElm, 0);
						var n = setTimeout(function(e) {
							i.checkCursorPosition(), clearTimeout(n), n = null
						}, 350);
						u.emit("change", "content", this)
				...
				value: function(e) {
					var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
						i = this.options.fixed ? "bottom" : "marginBottom";
					this.$content.style[i] = e + n.int(t) + "px"
				}
			}, {
				key: "getBase64Images",
				value: function() {
					for (var e = [], t = p.queryAll("img", this.$content), i = void 0, r = void 0, n = 0; n < t.length; n++) r =
						(i = t[n]).src, /^data:.+?;base64,/.test(r) && e.push({
							id: i.id,
							base64: r,
							blob: L(r)
						});
				...
				value: function(e, t) {
					...
					return !!i && (i.src = t, i.removeAttribute("id"), u.emit("change", "content", this), !0)
				}
			}, {
				key: "_visiblePostion",
				value: function() {
					var e = a.innerHeight,
						...
						i = n.int(t.top),
						r = 0;
					r = this.emojiModal && this.emojiModal.visible ? this.emojiModal.height : this.textstyleModal && this.textstyleModal
						.visible ? this.textstyleModal.height : n.int(t.bottom) + (t.showToolbar ? this.toolbarHeight : 0);
					var o = {
						fixed: t.fixed,
						winHeight: e,
						startY: i,
						endY: e - r - i - n.int(this.keyboard.height)
					};
					...
					if (!e.fixed) {
						...
						if (t) {
							...
							var r = p.getScroll("top"),
								n = 0;
							i.top < e.startY && (n = r - (e.startY - i.top) - 10, p.scrollTop(a, n)), i.bottom > e.endY && (n = r +
								e.endY + 10, p.scrollTop(a, n))
						}
					}
				}
			}, {
				key: "setContent",
				value: function(e) {
					this.$content.innerHTML = e, M(this.$content) || C(this.$content), this.cursor && (this.$cursorElm = this
						.cursor.getRange()), u.emit("change", "content", this)
				}
			}, {
				key: "getContent",
				value: function() {
					...
					for (t = 0; t < e.length; t++)
						if (3 === (i = e[t]).nodeType) {
							var r = n.trim(i.nodeValue);
							if (r) {
								var o = p.createElm("p");
								o.innerText = r, this.$content.replaceChild(o, i)
							}
		...
		for (var X in K.prototype.on = u.on, K.prototype.off = u.off, K.prototype.emit = u.emit, K.prototype.toBlobData =
				L, K.prototype.filesToBase64 = function(e, t, i) {
					if (e) {
						var r = e.length;
						if (r) {
							...
							var a = 0,
								...
								c = void 0,
								d = void 0;
							for (c = 0; c < r; c++)(d = e[c]).size > o ? (l.push({
								msg: "files[" + c + ']: "' + d.name + '" size is beyond the ' + this.options.imageMaxSize + "MB!"
							}), f()) : "undefined" == typeof EXIF ? (t.orientation = 0, u(d)) : EXIF.getData(d, function() {
								var e = EXIF.getAllTags(this) || {};
								t.orientation = e.Orientation, u(d)
							});
							e = null
						} else i([{
							msg: "files's length is " + r
						}])
					} else i([{
					...
					function u(e) {
						! function(e, t, i) {
							...
							r.readAsDataURL(e), r.onload = function() {
								var r = this.result;
								/^data:image\//i.test(r) ? (t.type = e.type, t.size = e.size, t.name = e.name, function(e, t, i) {
									var r = new Image;
									r.src = e, r.setAttribute("alt", t.name), r.onload = function(n) {
											...
											var o = function(e, t) {
												...
												if (t.orientation > 1) switch (t.orientation) {
													...
													case 3:
														...
														break;
													case 8:
														i.width = o, i.height = n, r.rotate(3 * Math.PI / 2), r.drawImage(e, -n, 0, n, o)
									...
									e ? i(e) : "image/gif" !== t.type ? function(e, t, i) {
										var r = e.type,
											o = function(e, t, i) {
												var r = n.int(i.width),
													o = n.int(i.height);
												if (!i.clip && r > 0 && e < r && o > 0 && t < o) return {
													sx: 0,
													sy: 0,
													sw: e,
													sh: t,
												...
												var a = 1,
													...
													p = 0,
													u = 0;
												return r > 0 && o > 0 ? (c = r, d = o, p = r, u = Math.floor(r * t / e), a = F(e, r), u >= o ? (l =
													0, s = n.int((u - o) / 2 * a)) : (a = F(t, o), p = Math.floor(o * e / t), u = o, l = n.int((p -
													r) / 2 * a), s = 0)) : r > 0 ? (a = F(e, r), c = r, d = Math.floor(r * t / e)) : o > 0 && (a = F(
													t, o), c = Math.floor(o * e / t), d = o), {
													sx: l,
													sy: s,
													sw: n.int(c * a),
													sh: n.int(d * a),
										...
										if (o.scaling > l) {
											...
											do {
												a = V(a, {
													...
													sw: s,
													sh: c
												}), s = a.width, c = a.height, d = p = 0, l -= 1
											} while (l > 2)
										}
										var u = (a = V(a, {
												cw: o.cw,
					...
					function f() {
						r === ++a && i(l.length ? l : null, s.length ? s : null)
					}
				}, p) p.hasOwnProperty(X) && (K.prototype[X] = p[X]);
		for (var q in n) n.hasOwnProperty(q) && (K.prototype[q] = n[q])
	}])
});
