...
(function(root, factory) {
	...
	function t(a, b) {
		...
		for (var d; a.length && (d = a.shift());) a.length || void 0 === b ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] :
			c = c[d] = {} : c[d] = b
	};
	var ba, da;
	...
	function Fa(a, b, c) {
		return c ? (c[0] = a[0] - b, c[1] = a[1] - b, c[2] = a[2] + b, c[3] = a[3] + b, c) : [a[0] - b, a[1] - b, a[2] + b,
			a[3] + b
		]
	}
	...
	function Ua(a, b, c) {
		var d;
		return (d = b.call(c, Wa(a))) || (d = b.call(c, Ya(a))) || (d = b.call(c, Za(a))) ? d : (d = b.call(c, $a(a))) ? d :
			!1
	}
	...
	function gb(a, b, c) {
		c = c ? c : Da();
		hb(a, b) && (c[0] = a[0] > b[0] ? a[0] : b[0], c[1] = a[1] > b[1] ? a[1] : b[1], c[2] = a[2] < b[2] ? a[2] : b[2],
			c[3] = a[3] < b[3] ? a[3] : b[3]);
		return c
	}
	...
	*/
	...
	ob.prototype.offset = function(a, b, c) {
		...
		return [180 * (va(a[0]) + Math.atan2(Math.sin(c) * Math.sin(b) * Math.cos(d), Math.cos(b) - Math.sin(d) * Math.sin(
	...
	function wb(a) {
		...
		var b = a.code,
			c = vb || window.proj4;
		"function" == typeof c && (b = c.defs(b), void 0 !== b && (void 0 !== b.axis && void 0 === a.axisOrientation && (
				this.b = b.axis), void 0 === a.metersPerUnit && (this.l = b.to_meter),
	...
	var Ab = 6378137 * Math.PI,
		yb = [-Ab, -Ab, Ab, Ab],
		zb = [-180, -85, 180, 85],
		Bb = [new xb("EPSG:3857"), new xb("EPSG:102100"), new xb("EPSG:102113"), new xb("EPSG:900913"), new xb(
			"urn:ogc:def:crs:EPSG:6.18:3:3857"), new xb("urn:ogc:def:crs:EPSG::3857"), new xb(
	...
	function Db(a, b, c) {
		...
		c = 1 < c ? c : 2;
		void 0 === b && (2 < c ? b = a.slice() : b = Array(d));
		for (var e = 0; e < d; e += c) b[e] = 180 * a[e] / Ab, b[e + 1] = 360 * Math.atan(Math.exp(a[e + 1] / 6378137)) /
			Math.PI - 90;
		return b
	};
	...
	var Fb = [-180, -90, 180, 90],
		...
		Hb = [new Eb("CRS:84"), new Eb("EPSG:4326", "neu"), new Eb("urn:ogc:def:crs:EPSG::4326", "neu"), new Eb(
			"urn:ogc:def:crs:EPSG:6.6:4326", "neu"), new Eb("urn:ogc:def:crs:OGC:1.3:CRS84"), new Eb(
			"urn:ogc:def:crs:OGC:2:84"), new Eb("http://www.opengis.net/gml/srs/epsg.xml#4326", "neu"), new Eb(
	...
	function Nb(a, b, c, d) {
		a = Ob(a);
		var e = a.j;
		e ? b = e(b, c) : "degrees" == a.a && !d || "degrees" == d || (e = Pb(a, Ob("EPSG:4326")), b = [c[0] - b / 2, c[1],
			c[0] + b / 2, c[1], c[0], c[1] - b / 2, c[0], c[1] + b / 2
		], b = e(b, b, 2), b = (Mb.b(b.slice(0, 2), b.slice(2, 4)) + Mb.b(b.slice(4, 6), b.slice(6, 8))) / 2, a = d ? ub[
			d] : a.Bc(), void 0 !== a && (b /= a));
		return b
	}
	...
	function Pb(a, b) {
		...
		if (!e) {
			...
			if ("function" == typeof f) {
				var g = f.defs(c),
					h = f.defs(d);
				void 0 !== g && void 0 !== h && (g === h ? Qb([b, a]) : (e = f(d, c), Vb(b, a, e.forward, e.inverse)), e = Lb(c,
					d))
			}
		}
		e || (e = $b);
	...
	function wc(a, b, c) {
		var d = a.Ic(b),
			e = a.Ta(b);
		a = Ba(a.Za(b), a.f);
		return Na(d[0] + c.fa * a[0] * e, d[1] + c.ea * a[1] * e, d[0] + (c.la + 1) * a[0] * e, d[1] + (c.ka + 1) * a[1] *
			e, void 0)
	}
	...
	Sc.prototype.removeEventListener = function(a, b) {
		var c = this.oa[a];
		c && (b = c.indexOf(b), a in this.Wa ? (c[b] = ea, ++this.Wa[a]) : (c.splice(b, 1), 0 === c.length && delete this.oa[
			a]))
	};
	...
	k.rq = function(a, b) {
		var c = this.kc();
		if (a < c) this.c && $c(this, b, a), c = this.a[a], this.a[a] = b, this.b(new cd("remove", c)), this.b(new cd(
			"add", b));
		else {
	...
	k.Om = function(a, b) {
		...
		if (c) {
			var d = c.out,
				e = c.pj;
			Gd(this.b, "pointermove", b, a);
			d && e !== b.target && (d.relatedTarget = b.target, b.relatedTarget = e, d.target = e, b.target ? (Jd(this.b, d,
				a), Hd(this.b, b, a)) : (b.target = e, b.relatedTarget = null, this.Of(a, b)));
			c.out = b;
			c.pj = b.target
		}
	};
	...
	function Xd(a) {
		...
		this.i = {};
		this.a = [];
		td ? Yd(this, new Nd(this)) : ud ? Yd(this, new Kd(this)) : (a = new Cd(this), Yd(this, a), sd && Yd(this, new Sd(
			this, a)));
		a = this.a.length;
	...
	function de(a, b) {
		"pointerup" == b.type || "pointercancel" == b.type ? delete a.o[b.pointerId] : "pointerdown" == b.type && (a.o[b.pointerId] = !
			0);
	...
	k.pm = function(a) {
		...
		this.b(b);
		this.c = a;
		0 === this.i.length && (this.a = new Xd(document), this.i.push(y(this.a, "pointermove", this.mn, this), y(this.a,
			"pointerup", this.ci, this), y(this.f, "pointercancel", this.ci, this)))
	};
	k.mn = function(a) {
		if (fe(this, a)) {
			this.l = !0;
	...
	ge.prototype.i = function(a) {
		...
		var b = this.s(a);
		return Infinity != b ? (this.b.push(a), this.g.push(b), this.a[this.c(a)] = !0, je(this, 0, this.b.length - 1), !0) :
			!1
	};
	...
	le.prototype.l = function(a) {
		a = a.target;
		var b = a.getState();
		if (2 === b || 3 === b || 4 === b || 5 === b) Mc(a, "change", this.l, this), a = a.lb(), a in this.f && (delete this
			.f[a], --this.j), this.v()
	};

	function me(a, b, c) {
		for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length;) g = he(a)[0], h = g.lb(), f = g.getState(), 5 ===
			f ? e = !0 : 0 !== f || h in a.f || (a.f[h] = !0, ++a.j, ++d, g.load());
		0 === d && e && a.v()
	};
	...
	function pe(a) {
		return function(b, c, d) {
			if (void 0 !== b) return b = fc(a, b, d), b = pa(b + c, 0, a.length - 1), c = Math.floor(b), b != c && c < a.length -
				1 ? a[c] / Math.pow(a[c] / a[c + 1], b - c) : a[c]
		}
	}

	function qe(a, b, c) {
		return function(d, e, f) {
			if (void 0 !== d) return d = Math.max(Math.floor(Math.log(b / d) / Math.log(a) + (-f / 2 + .5)) + e, 0), void 0 !==
				c && (d = Math.min(d, c)), b / Math.pow(a, d)
		}
	};
	...
	k.$a = function() {};
	k.na = function(a, b) {
		a ? (lf(this, b, a, 1), this.A || (this.A = []), this.A.length = wf(this.A, 0, a, this.a), this.u()) : Ef(this,
			"XY", null)
	};
	...
	function Gf(a, b, c, d, e, f) {
		for (var g = 0, h = a[c - d], l = a[c - d + 1]; b < c; b += d) {
			var m = a[b],
				n = a[b + 1];
			l <= f ? n > f && 0 < (m - h) * (f - l) - (e - h) * (n - l) && g++ : n <= f && 0 > (m - h) * (f - l) - (e - h) * (
				n - l) && g--;
			h = m;
			l = n
		}
	...
	function If(a, b, c, d, e, f, g) {
		...
		m = r[0];
		h = 1;
		for (l = r.length; h < l; ++h) n = r[h], z = Math.abs(n - m), z > v && (m = (m + n) / 2, Hf(a, b, c, d, m, q) && (u =
			m, v = z)), m = n;
		isNaN(u) && (u = e[f]);
	...
	function Lf(a, b, c, d, e) {
		var f = c[0];
		if (!(Kf(a, b, f, d, e) || Gf(a, b, f, d, e[0], e[1]) || Gf(a, b, f, d, e[0], e[3]) || Gf(a, b, f, d, e[2], e[1]) ||
				Gf(a, b, f, d, e[2], e[3]))) return !1;
	...
	k.na = function(a, b) {
		a ? (lf(this, b, a, 2), this.A || (this.A = []), a = xf(this.A, 0, a, this.a, this.c), this.A.length = 0 === a.length ?
			0 : a[a.length - 1], this.u()) : this.ba("XY", null, this.c)
	};
	k.ba = function(a, b, c) {
		kf(this, a, b);
		this.c = c;
	...
	function Tf(a, b, c, d) {
		var e = a.da(),
			...
			l = e.length / g - 1;
		d = d ? d : 0;
		for (var m, n, p = 0; p <= l; ++p) n = p * g, m = d + 2 * wa(p, l) * Math.PI / l, e[n] = b[0] + c * Math.cos(m), e[
			n + 1] = b[1] + c * Math.sin(m);
		a.ba(f, e, h)
	};
	...
	function Vf(a, b) {
		...
		a.j = b.resolutions;
		a.s = d;
		(void 0 !== b.enableRotation ? b.enableRotation : 1) ? (d = b.constrainRotation, d = void 0 === d || !0 === d ? we() :
			!1 === d ? se : "number" === typeof d ? ue(d) : se) : d = re;
		a.l = {
			center: void 0 !== b.extent ? ne(b.extent) : oe,
			resolution: e,
			rotation: d
		};
		void 0 !== b.resolution ? c.resolution = b.resolution : void 0 !== b.zoom && (c.resolution = a.constrainResolution(
			a.a,
	...
	k.animate = function(a) {
		...
		if (ag(this)) {
			for (var d = Date.now(), e = this.xa().slice(), f = this.Pa(), g = this.Sa(), h = [], l = 0; l < b; ++l) {
				...
				void 0 !== m.zoom ? (n.ke = f, n.kd = this.constrainResolution(this.a, m.zoom - this.s, 0), f = n.kd) : m.resolution &&
					(n.ke = f, n.kd = m.resolution, f =
						n.kd);
			...
			bg(this, 0, 1);
			this.Ff()
		} else b = arguments[b - 1], b.center && this.ub(b.center), void 0 !== b.zoom && this.Tj(b.zoom), void 0 !== b.rotation &&
			this.ce(b.rotation), c && c(!0)
	};
	k.Ac = function() {
		return 0 < this.f[0]
	};
			...
			for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
				for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
					...
					if (!h.complete) {
						...
						h.ke && h.kd && (l = 1 === b ? h.kd : h.ke + b * (h.kd - h.ke), h.anchor && this.set("center", cg(this, l, h.anchor)),
							this.set("resolution",
								l));
						void 0 !== h.Df && void 0 !== h.ne && (b = 1 === b ? wa(h.ne + Math.PI, 2 * Math.PI) - Math.PI : h.Df + b * (h
							.ne - h.Df), h.anchor && this.set("center", dg(this, b, h.anchor)), this.set("rotation", b));
						b = !0;
						if (!h.complete) break
					}
				}
	...
	function eg(a) {
		...
		if (a = document.querySelector(a)) a = getComputedStyle(a), b[0] = parseInt(a.width, 10), b[1] = parseInt(a.height,
			10);
		return b
	}
	k.Sc = function(a) {
	...
	k.Uf = function(a, b) {
		...
		var e = void 0 !== b.padding ? b.padding : [0, 0, 0, 0],
			...
			h;
		void 0 !== b.minResolution ? h = b.minResolution : void 0 !== b.maxZoom ? h = this.constrainResolution(this.a, b.maxZoom -
			this.s, 0) : h = 0;
		var l = d.da(),
			m = this.Sa();
		a = Math.cos(-m);
	...
	function G(a) {
		...
		for (var c = "click dblclick mousedown touchstart MSPointerDown pointerdown mousewheel wheel".split(" "), d = 0, e =
				c.length; d < e; ++d) y(this.v, c[d], Rc);
	...
	k.Tc = function(a, b, c) {
		if (this.c) return a = this.Ra(a), c = void 0 !== c ? c : {}, this.pc.wa(a, this.c, void 0 !== c.hitTolerance ? c.hitTolerance *
			this.c.pixelRatio : 0, b, null, void 0 !== c.layerFilter ? c.layerFilter : Re, null)
	};
	k.Xf = function(a, b) {
		var c = null;
	...
	k.tg = function(a, b, c, d, e) {
		if (this.c) return this.pc.Ti(a, this.c, b, void 0 !== c ? c : null, void 0 !== d ? d : Re, void 0 !== e ? e :
			null)
	};
	k.ng = function(a, b) {
		if (!this.c) return !1;
		a = this.Ra(a);
		b = void 0 !== b ? b : {};
		return this.pc.Ui(a, this.c, void 0 !== b.hitTolerance ? b.hitTolerance * this.c.pixelRatio : 0, void 0 !== b.layerFilter ?
			b.layerFilter : Re, null)
	};
	k.Sd = function(a) {
	...
	k.Am = function() {
		...
		var a = this.aa();
		a && (this.a.setAttribute("data-view", x(a)), this.B = y(a, "propertychange", this.ei, this), this.C = y(a,
			"change", this.ei, this));
		this.render()
	};
	k.fm = function() {
	...
	k.pq = function() {
		...
		this.c = g;
		this.pc.bh(g);
		g && (g.animate && this.render(), Array.prototype.push.apply(this.Ea, g.postRenderFunctions), !f || this.f && (bb(
				this.f) || Sa(g.extent, this.f)) || (this.b(new dd("movestart", this, f)), this.f = Oa(this.f)), !this.f || g.viewHints[
				0] ||
	...
	k.Oc = function() {
		...
		if (a) {
			...
			this.be([a.offsetWidth - parseFloat(b.borderLeftWidth) - parseFloat(b.paddingLeft) - parseFloat(b.paddingRight) -
				parseFloat(b.borderRightWidth), a.offsetHeight - parseFloat(b.borderTopWidth) - parseFloat(b.paddingTop) -
				parseFloat(b.paddingBottom) - parseFloat(b.borderBottomWidth)
			])
		} else this.be(void 0)
	};
	k.Zj = function(a) {
	...
	function sg(a) {
		var b = null;
		void 0 !== a.keyboardEventTarget && (b = "string" === typeof a.keyboardEventTarget ? document.getElementById(a.keyboardEventTarget) :
			a.keyboardEventTarget);
		var c = {},
			d = {};
		if (void 0 === a.logo || "boolean" === typeof a.logo && a.logo) d[
			...
			var e = a.logo;
			"string" === typeof e ? d[e] = "" : e instanceof HTMLElement ? d[x(e).toString()] = e : e && (oa("string" ==
				typeof e.href, 44), oa("string" == typeof e.src, 45), d[e.src] = e.href)
		}
		...
		var f;
		void 0 !== a.renderer ? (Array.isArray(a.renderer) ? f = a.renderer : "string" === typeof a.renderer ? f = [a.renderer] :
			oa(!1, 46), 0 <= f.indexOf("dom") && (f = f.concat(ug))) : f = ug;
		e = 0;
		var g =
			f.length;
		a: for (; e < g; ++e)
	...
	vg.prototype.setMap = function(a) {
		...
		for (var b = 0, c = this.s.length; b < c; ++b) Gc(this.s[b]);
		this.s.length = 0;
		if (this.a = a)(this.T ? this.T : a.v).appendChild(this.element), this.render !== ea && this.s.push(y(a,
			"postrender", this.render, this)), a.render()
	};
	...
	function zg(a) {
		...
		c.className = b + " ol-unselectable ol-control" + (this.c && this.j ? " ol-collapsed" : "") + (this.j ? "" :
			" ol-uncollapsible");
	...
	function Ag(a) {
		if (a = a.frameState) {
			...
			if (!jc(c, this.B)) {
				...
				0 === c.length && 0 <
					this.B.length ? this.element.classList.add("ol-logo-only") : 0 === this.B.length && 0 < c.length && this.element
					.classList.remove("ol-logo-only");
	...
	function Cg(a) {
		...
		this.c = null;
		"string" === typeof c ? (this.c = document.createElement("span"), this.c.className = "ol-compass", this.c.textContent =
			c) : (this.c = c, this.c.classList.add("ol-compass"));
		...
		if (a = a.frameState) {
			...
			if (a != this.o) {
				...
				if (this.j) {
					...
					c || 0 !== a ? c && 0 !== a && this.element.classList.remove("ol-hidden") : this.element.classList.add(
						"ol-hidden")
				}
	...
	function Lg(a, b, c, d) {
		...
		c && void 0 !== b && b !== e && (f = a.xa(), c = cg(a, b, c), c = a.Sc(c), c = [(b * f[0] - e * c[0]) / (b - e), (b *
			f[1] - e * c[1]) / (b - e)]);
		Tg(a, b, c, d)
	}
	...
	function gh(a) {
		...
		this.D ? "pointerdrag" == a.type ? this.Ek(a) : "pointerup" == a.type && (this.D = this.Lk(a) && 0 < this.l.length) :
			"pointerdown" == a.type ? (this.D = a = this.ck(a), b = this.jd(a)) : "pointermove" == a.type && this.Kk(a);
		return !b
	}
	...
	function Gh(a) {
		...
		if ("keydown" == a.type || "keypress" == a.type) {
			...
			!this.f(a) || 43 != c && 45 != c || (b = 43 == c ? this.a : -this.a, c = a.map.aa(), Lg(c, b, void 0, this.j), a.preventDefault(),
				b = !0)
		}
		return !b
	};
	...
	function Sh(a) {
		return 2 <= this.l.length ? (a = a.map, this.f = null, this.j = void 0, this.a = !1, this.s = 0, this.D || bg(a.aa(),
			1, 1), !0) : !1
	}
	Rh.prototype.jd = Se;
	...
	function Wh(a) {
		return 2 <= this.l.length ? (a = a.map, this.f = null, this.a = void 0, this.j = 1, this.D || bg(a.aa(), 1, 1), !0) :
			!1
	}
	Vh.prototype.jd = Se;
	...
	var oi = function() {
		...
		return function(b) {
			var c = li[b];
			void 0 == c && (a || (a = document.createElement("span"), a.textContent = "M", a.style.margin = a.style.padding =
					"0 !important", a.style.position = "absolute !important", a.style.left = "-99999px !important"), a.style.font =
				b, document.body.appendChild(a), c = li[b] = a.offsetHeight, document.body.removeChild(a));
			return c
		}
	}();
	...
	var wi = function() {
		...
		return function(c) {
			if (a.hasOwnProperty(c)) var d = a[c];
				...
				d = c;
				ui.exec(d) && (e = document.createElement("div"), e.style.color = d, document.body.appendChild(e), d =
					getComputedStyle(e).color, document.body.removeChild(e));
				if (ti.exec(d)) {
					e = d.length - 1;
					var f = 4 >= e ? 1 : 2;
					var g = 4 === e || 8 === e;
					...
					f = [e, h, l, d / 255]
				} else 0 == d.indexOf("rgba(") ? (d = d.slice(5, -1).split(",").map(Number), f = yi(d)) : 0 == d.indexOf("rgb(") ?
					(d = d.slice(4, -1).split(",").map(Number), d.push(1), f = yi(d)) : oa(!1, 14);
				d = f;
				a[c] = d;
				++b
			}
	...
	function Di(a, b, c, d) {
		...
		if (a.qa && "" !== a.ta) {
			...
			h ? (h.font != f.font && (h.font = g.font = f.font), h.textAlign != l && (h.textAlign = l), h.textBaseline != f.textBaseline &&
				(h.textBaseline = g.textBaseline = f.textBaseline)) : (g.font = f.font, g.textAlign = l, g.textBaseline = f.textBaseline,
				a.Wa = {
					font: f.font,
					textAlign: l,
	...
	function Fi(a, b) {
		...
		d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), od && (jc(d.lineDash, b.lineDash) || c.setLineDash(
					d.lineDash = b.lineDash), d.lineDashOffset != b.lineDashOffset && (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)),
				d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth =
					c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle !=
				b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) :
			(c.lineCap = b.lineCap, od && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin,
				c.lineWidth = b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.O = {
					lineCap: b.lineCap,
					lineDash: b.lineDash,
	...
	function Ui(a, b) {
		b = b.T;
		void 0 !== b && ("string" === typeof b ? a.logos[b] = "" : b && (oa("string" == typeof b.href, 44), oa("string" ==
	...
	function Vi(a, b, c, d) {
		b = x(b).toString();
		c = c.toString();
		b in a ? c in a[b] ? (a = a[b][c], d.fa < a.fa && (a.fa = d.fa), d.la > a.la && (a.la = d.la), d.ea < a.ea && (a.ea =
			d.ea), d.ka > a.ka && (a.ka = d.ka)) : a[b][c] = d : (a[b] = {}, a[b][c] = d)
	}
	...
	aj.prototype.df = function(a, b, c) {
		...
		if (d) {
			...
			c.drawImage(d, 0, 0, +d.width, +d.height, Math.round(e[4]), Math.round(e[5]), Math.round(d.width * e[0]), Math.round(
				d.height * e[3]));
			c.globalAlpha = g;
			f && c.restore()
		}
	...
	bj.prototype.$c = function(a, b) {
		...
		if (!l[0] && !l[1] && !bb(m))
			if (l = e.projection, e = this.c) {
				...
				!e.$c(n, b) || !e.j && jc(p, this.o) || (l.canvas.width = n.size[0] * c, l.canvas.height = n.size[1] * c, e.df(n,
						b, l), this.M = new ai(m, g, c, l.canvas), this.o =
					p)
			} else(e = h.Y(m, g, c, l)) && Si(this, e) && (this.M = e);
		this.M && (e = this.M, m = e.G(), b = e.resolution, e = e.a, l = c * b / (g * e), m = ef(this.f, c * d[0] / 2, c *
			d[1] / 2, l, l, 0, e * (m[0] - f[0]) / b, e * (f[1] - m[3]) / b), ef(this.l, c * d[0] / 2 - m[4], c * d[1] / 2 -
			m[5], c / g, -c / g, 0, -f[0], -f[1]), Ui(a, h), this.i = b * c / e);
		return !!this.M
	};
	...
	mj.prototype.$c = function(a, b) {
		...
		xa = a.viewHints;
		xa = xa[0] || xa[1];
		if (!(this.i && 16 < Date.now() - a.time && xa || !la && this.c && La(this.c, u) && this.wf == m && r == this.C &&
				(xa || q * c / A * r == this.i))) {
			if (xa = this.context) ia = l.Zd(p, c, f), ca = Math.round((v.la - v.fa + 1) * ia[0] / r), ia = Math.round((v.ka -
				v.ea + 1) * ia[1] / r), la = xa.canvas, la.width != ca || la.height != ia ? (this.C = r, la.width = ca, la.height =
				ia) : (this.c && !Sa(z, this.c) && xa.clearRect(0, 0, ca, ia), r = this.C);
			this.f.length = 0;
		...
		b = this.i / g;
		b = ef(this.o, c * d[0] / 2, c * d[1] / 2, b, b, 0, (this.c[0] - e[0]) / this.i * c, (e[1] - this.c[3]) / this.i *
			c);
	...
	(function(a) {
		...
		f.prototype = {
			...
			search: function(a) {
				...
				for (var e = [], f, g, h, l; b;) {
					f = 0;
					for (g = b.children.length; f < g; f++) h = b.children[f], l = b.fb ? d(h) : h, u(a, l) && (b.fb ? c.push(h) :
						r(a, l) ? this.rh(h, c) : e.push(h));
					b = e.pop()
				}
				return c
			},
			...
			load: function(a) {
				...
				this.data.children.length ? this.data.height === a.height ? this.yh(this.data, a) : (this.data.height < a.height &&
					(b = this.data, this.data = a, a = b), this.vh(a, this.data.height - a.height - 1, !0)) : this.data = a;
				return this
			},
			Ca: function(a) {
			...
			remove: function(a, b) {
				...
				for (var c = this.data, d = this.xb(a), e = [], f = [], g, h, l, m; c || e.length;) {
					...
					m || c.fb || !r(c, d) ? h ? (g++, c = h.children[g], m = !1) : c = null : (e.push(c), f.push(g), g = 0, h = c,
						c = c.children[0])
				}
				return this
			},
			...
			xk: function(a, b, c, d) {
				for (var e, f, g, h, l, m, n, q;;) {
					...
					n = q = Infinity;
					e = 0;
					for (f = b.children.length; e < f; e++) g = b.children[e], l = p(g), m = (Math.max(g.la, a.la) - Math.min(g.fa,
							a.fa)) * (Math.max(g.ka, a.ka) - Math.min(g.ea, a.ea)) - l, m < q ? (q = m, n = l < n ? l : n, h = g) : m ===
						q && l < n && (n = l, h = g);
					b = h || b.children[0]
				}
				return b
			...
			yk: function(a) {
				for (var b = a.length - 1, c; 0 <= b; b--) 0 === a[b].children.length ? 0 < b ? (c = a[b - 1].children, c.splice(
					c.indexOf(a[b]), 1)) : this.clear() : g(a[b], this.xb)
			},
			Ak: function(a) {
				var b = ["return a", " - b", ";"];
				this.Pf = new Function("a", "b", b.join(a[0]));
				this.Qf = new Function("a", "b", b.join(a[1]));
				this.xb = new Function("a", "return {minX: a" + a[0] + ", minY: a" + a[1] + ", maxX: a" + a[2] + ", maxY: a" +
					a[3] + "};")
			}
		};
		a["default"] = f
	...
	function zj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, v, z, A, E) {
		...
		z = null;
		0 !== q ? (f = c + f, g = d + g, z = ef(Ia, f, g, 1, 1, q, -f, -g), Oa(v), Ea(v, af(Ia, xa)), Ea(v, af(Ia, Va)), Ea(
			v, af(Ia, ic)), Ea(v, af(Ia, Xa))) : Na(ca, ia, ca + ta, ia + la, v);
		q = b.canvas;
		q = v[0] <= q.width &&
			0 <= v[2] && v[1] <= q.height && 0 <= v[3];
		if (h) {
			if (q || 1 != h[4]) Ta(h, v), (a = q ? [b, z ? z.slice(0) : null, m, e, n, p, u, l, c, d, r] : null) && S && a.push(
				A, E, xa, Va, ic, Xa), h.push(a)
	...
	function Bj(a, b, c, d, e, f, g) {
		...
		for (p = c + e; p < d; p += e) {
			...
			m[1] = b[p + 1];
			var q = Ma(l, m);
			q !== r ? (n && (a.coordinates[h++] = g[0], a.coordinates[h++] = g[1]), a.coordinates[h++] = m[0], a.coordinates[h++] =
				m[1], n = !1) : 1 === q ? (a.coordinates[h++] = m[0], a.coordinates[h++] = m[1], n = !1) : n = !0;
			g[0] = m[0];
			g[1] = m[1];
			var r = q
		}
	...
	k.Hh = function(a, b, c) {
		...
		} else "Polygon" == d || "MultiLineString" == d ? (h = [], d = "Polygon" == d ? a.Xb() : a.da(), Dj(this, d, 0, a.pb(),
			e, h), this.a.push([4, f, h, a, c, zf])) : "LineString" == d || "MultiPoint" == d ? (d = a.da(), e = Bj(this, d,
			0, d.length, e, !1, !1), this.a.push([4, f, e, a, c, yf])) : "Point" == d && (d = a.da(), this.coordinates.push(
			d[0],
	...
	function Hj(a, b, c, d, e, f, g) {
		...
		for (var l = !nb(d), m = 0, n = e.length, p = 0, q, r, u, v, z, A, E, S, Ia, ta = 0, la = 0, ca = null, ia = null,
				xa = a.Ub, Va = a.$, ic = {
					context: b,
			...
			switch (Z[0]) {
				...
				case 6:
					...
					for (Bu && (jp += Va); p < q; p += 2) zj(a, b, h[p], h[p + 1], Ia, r, u, S, rf, yu, zu, Au, jp, Cu, Du, Eu, kp,
						lp ? ca : null, mp ? ia : null);
					Gj(a, S, Zb);
					++m;
					break;
				case 5:
					...
					if (Fu || xp <= wp) {
						a: {
							var Ni = void 0,
								...
								Lh = sf[ve],
								Mh = sf[ve + 1];ve += 2;
							for (var Og = sf[ve], Pg = sf[ve + 1], Ok = 0, Oi = Math.sqrt(Math.pow(Og - Lh, 2) + Math.pow(Pg - Mh, 2)), Yf =
									"", Pk = 0, Pi = 0; Pi < Cp; ++Pi) {
								yp = Kh ? Cp - Pi - 1 : Pi;
								var Qk = Ap.charAt(yp);
								Yf = Kh ? Qk + Yf : Yf + Qk;
								var Qg = Hu(Yf) - Pk;
								Pk += Qg;
								for (var Dp = Bp + Qg / 2; ve < zp - 2 && Ok + Oi < Dp;) Lh = Og, Mh = Pg, ve += 2, Og = sf[ve], Pg = sf[ve +
									1], Ok += Oi, Oi = Math.sqrt(Math.pow(Og - Lh, 2) + Math.pow(Pg - Mh, 2));
								var Ju = Dp - Ok,
								...
								var Ep = Ju / Oi,
									Fp = ya(Lh, Og, Ep),
									Gp = ya(Mh, Pg, Ep);
								Ni == Rg ? (Kh && (Xf[0] = Fp, Xf[1] = Gp, Xf[2] = Qg / 2), Xf[4] = Yf) : (Yf = Qk, Pk = Qg, Xf = [Fp, Gp, Qg /
									2, Rg, Yf
						...
						if (Sg) {
							...
							if (pp)
								for (Zf = 0, Ri = Sg.length; Zf < Ri; ++Zf) ee = Sg[Zf], Rk = ee[4], Ne = a.Y(Rk, Mk, pp, ""), r = ee[2], u =
									Lk * Ne.height - rp, zj(a, b, ee[0], ee[1], Ne, r, u, S, Ne.height, 1, 0, 0, ee[3], vp, !1, Ne.width, hi,
										null, null)
						}
					}
					Gj(a, S, Zb);
				...
				case 9:
					...
					for (p += 2; p < q; p += 2)
						if (Nh = h[p],
							Oh = h[p + 1], A = Nh + .5 | 0, E = Oh + .5 | 0, p == q - 2 || A !== v || E !== z) b.lineTo(Nh, Oh), v = A, z =
							E;
					++m;
					break;
				case 10:
	...
	k.Oa = function(a, b) {
		...
		b ? (a = b.a, c.strokeStyle = zi(a ? a : gi), a = b.f, c.lineCap = void 0 !== a ? a : "round", a = b.g, c.lineDash =
			a ? a.slice() : fi, a = b.i, c.lineDashOffset = a ? a : 0, a = b.j, c.lineJoin = void 0 !== a ? a : "round", a =
			b.c, c.lineWidth = void 0 !== a ? a : 1, b = b.l, c.miterLimit = void 0 !== b ? b : 10, c.lineWidth > this.Wa &&
			(this.Wa = c.lineWidth, this.i = null)) : (c.strokeStyle = void 0, c.lineCap = void 0, c.lineDash = null, c.lineDashOffset =
	...
	k.pd = function(a) {
		this.a.push([11, a.strokeStyle, a.lineWidth * this.pixelRatio, a.lineCap, a.lineJoin, a.miterLimit, Aj(this, a.lineDash),
	...
	function Lj(a, b, c) {
		var d = b.strokeStyle,
			...
			l = b.lineWidth,
			m = b.miterLimit;
		if (b.Vk != d || b.Qk != e || f != b.Fh && !jc(b.Fh, f) || b.Rk != g || b.Sk != h || b.Tk != l || b.Uk != m) c.call(
			a, b), b.Vk = d, b.Qk = e, b.Fh = f, b.Rk = g, b.Sk = h, b.Tk = l, b.Uk = m
	}
	...
	Mj.prototype.yc = function(a, b) {
		if (this.M) {
			...
			this.a.push([6, d, a, this.M, this.g, this.c, this.B, this.f, this.j, this.D, this.C, this.l, this.s, this.v *
				this.pixelRatio, this.o, this.N
			]);
			this.b.push([6, d, a, this.V, this.g, this.c, this.B, this.f, this.j, this.D, this.C, this.l, this.s, this.v,
				this.o, this.N
			]);
			Fj(this, b)
		}
	...
	Nj.prototype.uc = function(a, b) {
		var c = this.state,
			d = c.lineWidth;
		void 0 !== c.strokeStyle && void 0 !== d && (Lj(this, c, this.pd), Ej(this, b), this.b.push([11, c.strokeStyle, c.lineWidth,
			c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset
	...
	Nj.prototype.vc = function(a, b) {
		...
		if (void 0 !== c.strokeStyle && void 0 !== d) {
			Lj(this, c, this.pd);
			Ej(this, b);
			this.b.push([11, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset],
				[1]);
			c = a.pb();
			d = a.da();
			a = a.pa();
	...
	Pj.prototype.cc = function(a, b) {
		...
		if (void 0 !== c.fillStyle || void 0 !== d) {
			...
			void 0 !== c.strokeStyle && this.b.push([11, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash,
				c.lineDashOffset
			]);
			var e = a.da();
			d = this.coordinates.length;
				...
				for (var p = l.length; f < p; ++f) {
					if (void 0 == a) {
						for (var q,
							...
							var ta = d[m],
								la = d[m + 1];
							void 0 !== r && (r = ta - r, q = la - q, g = Math.sqrt(r * r + q * q), void 0 !== v && (S += z, u = Math.acos(
									(v * r + u * q) / (z * g)), u > e.maxAngle && (S > E && (E = S, n = Ia, A = m), S = 0, Ia = m - h)), z = g,
								v = r, u = q);
							r = ta;
							q = la
						}
	...
	Sj.prototype.Y = function(a, b, c, d) {
		...
		if (!ii.a.hasOwnProperty(e)) {
			...
			r.font =
				h.font;
			d && (r.strokeStyle = f.strokeStyle, r.lineWidth = b * (kd ? l : 1), r.lineCap = f.lineCap, r.lineJoin = f.lineJoin,
				r.miterLimit = f.miterLimit, od && f.lineDash.length && (r.setLineDash(f.lineDash), r.lineDashOffset = f.lineDashOffset)
			);
	...
	function Uj(a, b, c, d) {
		...
		a.a.push([6, c, d, b, (h - a.D) * g, (l - a.l) * g, a.N, b.height, 1, 0, 0, a.C, a.B, 1, !0, b.width, e.padding ==
			hi ? hi : e.padding.map(function(a) {
				return a * g
			}), !!e.backgroundFill, !!e.backgroundStroke
		]);
		a.b.push([6, c, d, b, (h - a.D) * g, (l - a.l) * g, a.N, b.height, 1, 0, 0, a.C, a.B, 1 / g, !0, b.width, e.padding,
			!!e.backgroundFill, !!e.backgroundStroke
		])
	}
	...
	Sj.prototype.nb = function(a, b) {
		...
		if (a) {
			...
			this.C = void 0 === g ? !1 : g;
			this.B = void 0 === h ? 0 : h;
			this.V = d ? ("string" == typeof d.strokeStyle ? d.strokeStyle : x(d.strokeStyle)) + d.lineCap + d.lineDashOffset +
				"|" + d.lineWidth + d.lineJoin + d.miterLimit + "[" + d.lineDash.join() + "]" : "";
	...
	function Yj(a) {
		...
		b = a;
		for (var e = d = 0; b >= d;) Xj(c, a + b, a + d), Xj(c, a + d, a + b), Xj(c, a - d, a + b), Xj(c, a - b, a + d), Xj(
			c, a - b, a - d), Xj(c, a - d, a - b), Xj(c, a + d, a - b), Xj(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e -
			b) + 1 && (--b, e += 1 - 2 * b);
		return Wj[a] = c
	}
	k = Vj.prototype;
	...
	k.df = function(a, b, c) {
		...
		if (r && !r.yg()) {
			...
			qi(A, l, S / 2, e / 2);
			A != c && (z && Zi(this, "render", A, a, p), v ? (d = c.globalAlpha, c.globalAlpha = b.opacity, c.drawImage(A.canvas,
				-q, -u), c.globalAlpha = d) : c.drawImage(A.canvas,
				-q, -u), A.translate(-q, -u));
			v || (A.globalAlpha = E)
		}
		g && c.restore();
	...
	k.$c = function(a, b) {
		var c = this.a,
			d = c.g;
		this.B != d && (this.f.length = 0, c = c.l, this.context || "vector" == c || (this.context = hg()), this.context &&
			"vector" == c && (this.context = null));
		this.B = d;
	...
	k.Sf = function(a, b, c, d, e, f, g, h, l) {
			...
			for (var Ia = 0, ta = m.a.length; Ia < ta; ++Ia) {
				...
				if (3 != la.getState()) {
					...
					for (var Zb, Le = 0,
						...
						if (Zb = Z[Le], ic && ("tile-pixels" == Va.a && (Va.Sj(ca), Va.Si(la.G())), Zb.U().mb(Va, q)), !xa || hb(xa,
								Zb.U().G())) {
							var Id = void 0,
								te = Zb.ib();
		...
		if (this.context) {
			...
			r = n.g;
			if ((p = kk[n.l]) && q.fh !== r)
				for (q.fh = r, z = m.l, S = z[0], q = v.pixelRatio, rf = n.ha(), A = rf.eb(v.viewState.projection), r = A.Ta(S),
					u = nk(m, n), v = rf.Zd(S, q, v.viewState.projection), u.canvas.width = v[0], u.canvas.height = v[1], v = A.Ma(
						z), z = 0, A = m.a.length; z < A; ++z) S = m.c[m.a[z]], 3 != S.getState() && (rf = q / r, E = Xe(this.ca), cf(
					E, rf, -rf), df(E, -v[0], -v[3]), ok(S, n, m.ya.toString()).Na(u, E, 0, {}, p));
				...
				for (var z = v.ya, A = f.Ma(z)[0] - f.Ma(v.l)[0], E = void 0, S = 0, Ia = v.a.length; S < Ia; ++S) {
					...
					if (3 != ta.getState()) {
						...
						if (ca) {
							...
							ia = 0;
							for (xa = n.length; ia < xa; ++ia) Va = n[ia], ta < r[ia] && (a.beginPath(), a.moveTo(ca[0], ca[1]), a.lineTo(
								ca[2], ca[3]), a.lineTo(ca[4], ca[5]), a.lineTo(ca[6], ca[7]), a.moveTo(Va[6], Va[7]), a.lineTo(Va[4], Va[
								5]), a.lineTo(Va[2], Va[3]), a.lineTo(Va[0], Va[1]), a.clip());
							la.Na(a, E, m, {}, h, e);
							a.restore();
							n.push(ca);
							r.push(ta)
	...
	k.Dp = function(a) {
		if (null !== a.alpha) {
			var b = va(a.alpha);
			this.set(rk, b);
			"boolean" === typeof a.absolute && a.absolute ? this.set(sk, b) : "number" === typeof a.webkitCompassHeading && -
				1 != a.webkitCompassAccuracy && this.set(sk, va(a.webkitCompassHeading))
		}
	...
	k.$m = function() {
		if (qd) {
			var a = this.li();
			a && !this.a ? this.a = y(window, "deviceorientation", this.Dp, this) : a || null === this.a || (Gc(this.a), this
				.a = null)
		}
	};
	k.rg = function(a) {
	...
	function xk(a, b) {
		...
		if (void 0 === b) {
			...
			Math.round(m), (d = !a.Xa) && (n = a.Ih.bind(a, c)), a.Ya ? (e = a.Ya, void 0 === e.b && (e.b = "s", e.b = e.a ?
				"string" === typeof e.a ? e.b + e.a : e.b + x(e.a).toString() : e.b + "-", e.b += "," + (void 0 !== e.f ? e.f.toString() :
					"-") + "," + (e.g ? e.g.toString() : "-") + "," + (void 0 !== e.i ? e.i : "-") + "," + (void 0 !== e.j ? e.j :
					"-") + "," + (void 0 !== e.l ? e.l.toString() : "-") + "," + (void 0 !== e.c ? e.c.toString() : "-")), e = e.b) :
			e = "-", a.Xa ? (f = a.Xa, void 0 === f.a && (f.a = f.b instanceof CanvasPattern || f.b instanceof CanvasGradient ?
				x(f.b).toString() : "f" + (f.b ? xi(f.b) : "-")), f = f.a) :
			f = "-", a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.g == a.c[4] && a.j == a.c[5] && a.l == a.c[6] ||
			(a.c = ["r" + e + f + (void 0 !== a.b ? a.b.toString() : "-") + (void 0 !== a.g ? a.g.toString() : "-") + (void 0 !==
				a.j ? a.j.toString() : "-") + (void 0 !== a.l ? a.l.toString() : "-"), e, f, a.b, a.g, a.j, a.l]), n = b.add(a.c[
				0], m, m, a.Jh.bind(a, c), n), a.o = n.image, a.oa = [n.offsetX, n.offsetY], b = n.image.width, a.D = d ? n.Bm :
			a.o;
		a.C = [m / 2, m / 2];
		a.qa = [m, m];
		a.B = [b, b]
	...
	k.Jh = function(a, b, c, d) {
		...
		this.Ya && (b.strokeStyle = a.strokeStyle, b.lineWidth = a.Wj, a.lineDash && (b.setLineDash(a.lineDash),
				b.lineDashOffset = a.lineDashOffset), b.lineCap = a.lineCap, b.lineJoin = a.lineJoin, b.miterLimit = a.miterLimit,
			b.stroke());
		b.closePath()
	};
	k.Ih = function(a, b, c, d) {
		...
		b.fillStyle = ei;
		b.fill();
		this.Ya && (b.strokeStyle = a.strokeStyle, b.lineWidth = a.Wj, a.lineDash && (b.setLineDash(a.lineDash), b.lineDashOffset =
				a.lineDashOffset),
			b.stroke());
		b.closePath()
	};
	...
	k.fn = function() {
		if (rd) {
			var a = this.ni();
			a && void 0 === this.c ? this.c = navigator.geolocation.watchPosition(this.Pp.bind(this), this.Qp.bind(this),
				this.ai()) : a || void 0 === this.c || (navigator.geolocation.clearWatch(this.c), this.c = void 0)
		}
	};
	k.Pp = function(a) {
		a = a.coords;
	...
	function Kk(a, b, c, d, e, f) {
		...
		if (1 === l) g = a[b], h = a[b + 1];
			...
			e = n ? l : ~l;
			0 > e ? (c = (c - g[-e - 2]) / (g[-e - 1] - g[-e - 2]), b += (-e - 2) * d, g = ya(a[b], a[b + d], c), h = ya(a[b +
				1], a[b + d + 1], c)) : (g = a[b + e * d], h = a[b + e * d + 1])
		}
		return f ?
			(f[0] = g, f[1] = h, f) : [g, h]
	}
	...
	k.Tn = function(a, b) {
		return "XYM" != this.ja && "XYZM" != this.ja ? null : Sk(this.A, 0, this.A.length, this.a, a, void 0 !== b ? b : !
			1)
	};
	k.W = function() {
		return yf(this.A, 0, this.A.length, this.a)
	...
	k.na = function(a, b) {
		a ? (lf(this, b, a, 1), this.A || (this.A = []), this.A.length = wf(this.A, 0, a, this.a), this.u()) : this.ba(
			"XY", null)
	};
	k.ba = function(a, b) {
		kf(this, a, b);
	...
	function Uk(a, b, c) {
		for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f, e], m = [h, g], n = [1, 0], p = {}, q = 1E5, r, u,
				v, z, A; 0 < --q && 0 < n.length;) v = n.pop(), e = l.pop(), g = m.pop(), f = v.toString(), f in p || (d.push(g[0],
			g[1]), p[f] = !0), z = n.pop(), f = l.pop(), h = m.pop(), A = (v + z) / 2, r = a(A), u = b(r), sa(u[0], u[1], g[0],
			g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), f = z.toString(), p[f] = !0) : (n.push(z, A, A, v), m.push(h, u, u,
			g), l.push(f, r, r, e));
		return d
	}
	...
	function Xk(a) {
		...
		1 == a.showLabels && (this.$ = void 0 == a.lonLabelFormatter ? Ce.bind(this, "EW") : a.lonLabelFormatter, this.Wa =
			void 0 == a.latLabelFormatter ? Ce.bind(this, "NS") : a.latLabelFormatter,
			this.ca = void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.V = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition,
	...
	function $k(a, b, c, d, e, f, g) {
		...
		h.ba("XY", c);
		hb(h.G(), f) && (a.b && (c = g, d = h.da(), f = [d[0], pa(f[1] + Math.abs(f[1] - f[3]) * a.ca, Math.max(f[1], d[1]),
			Math.min(f[3], d[d.length - 1]))], c = void 0 !== a.b[c] ? a.b[c].Qd : new C(null), c.na(f), a.b[g] = {
			Qd: c,
			text: a.$(b)
		}), a.g[g++] = h);
		return g
	...
	function al(a, b, c, d, e, f, g) {
		...
		h.ba("XY", c);
		hb(h.G(), f) && (a.a && (c = g, d = h.da(), f = [pa(f[0] + Math.abs(f[0] - f[2]) * a.V, Math.max(f[0], d[0]), Math.min(
			f[2], d[d.length - 2])), d[1]], c = void 0 !== a.a[c] ? a.a[c].Qd : new C(null), c.na(f), a.a[g] = {
			Qd: c,
			text: a.Wa(b)
		}), a.c[g++] = h);
		return g
	...
	k.load = function() {
		if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.g = [Lc(this.M, "error", this.kn, this), Lc(
			this.M, "load", this.ln, this)], this.c(this, this.i)
	};
	k.ih = function(a) {
		this.M = a
	};
	...
	k.load = function() {
		...
		0 == this.state && (this.state = 1, this.u(), this.c = [Lc(this.M, "error", this.hn, this), Lc(this.M, "load",
			this.jn, this)], this.v(this, this.l))
	};
	...
	ql.prototype.Na = function(a, b, c, d, e, f, g, h, l, m, n) {
		...
		if (void 0 === l) this.Od(p, a, h, !1);
			...
			m ? a = this.Ee(p, a, h, l, n) : (p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT), this.Od(p, a, h, !0), a = (a =
				l(null)) ? a : void 0);
			var ta = a
		}
		this.Cf(p, f);
		this.f && (q || p.disable(p.STENCIL_TEST), p.clear(p.STENCIL_BUFFER_BIT), p.stencilFunc(r, v, u), p.stencilMask(z),
			p.stencilOp(A, S, E));
		return ta
	};
	...
	k.cc = function(a, b) {
		...
		if (c) {
			...
			var e = b / 4,
				f;
			for (f = 0; 2 > f; f += d) this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 0, this.a[b++] = this.N,
				this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 1, this.a[b++] = this.N, this.a[b++] = a[f], this.a[b++] =
				a[f + 1], this.a[b++] = 2, this.a[b++] = this.N, this.a[b++] = a[f], this.a[b++] =
				a[f + 1], this.a[b++] = 3, this.a[b++] = this.N, this.b[c++] = e, this.b[c++] = e + 1, this.b[c++] = e + 2, this
				.b[c++] = e + 2, this.b[c++] = e + 3, this.b[c++] = e, e += 4
		} else this.c.u && (this.l.pop(), this.l.length && (d = this.l[this.l.length - 1], this.c.fillColor = d[0], this.c
			.strokeColor = d[1], this.c.lineWidth = d[2], this.c.u = !1))
	};
	k.gb = function() {
	...
	k.Oa = function(a, b) {
		...
		this.c.strokeColor && jc(this.c.strokeColor, c) && this.c.fillColor && jc(this.c.fillColor, a) && this.c.lineWidth ===
			b || (this.c.u = !0, this.c.fillColor = a, this.c.strokeColor = c, this.c.lineWidth = b, this.l.push([a, c, b]))
	};
	var El = new il(
		...
		if (nb(c)) {
			...
			for (f = g = 0, h = e.length; f < h; ++f) {
				...
				for (var l = 0 < f ? d[f - 1] : 0, m = d[f], n = l; g < this.g.length && this.g[g] <= m;) {
					...
					void 0 !== c[p] ? (n !== l && sl(a, b, n, l), l = n = g === this.g.length - 1 ? m : this.g[g + 1]) : l = g ===
						this.g.length - 1 ? m : this.g[g + 1];
					g++
				}
				n !== l && sl(a, b, n, l)
			}
	...
	k.Zb = function(a) {
		...
		0 === this.c.length ? this.c.push(e) : (n = this.c[this.c.length - 1], x(n) != x(e) && (this.o.push(this.b.length),
			this.c.push(e)));
		this.D = b[0];
		this.C = b[1];
		this.height = m[1];
	...
	function Wl(a, b, c, d) {
		...
		for (e = 0; e < c; e += d) {
			...
			if (0 === e) {
				...
				if (m) {
					...
					l && (f = Xl(a, [0, 0], u, v, p * Yl * l, f), f = Xl(a, [0, 0], u, v, -p * Yl * l, f), a.b[g++] = q + 2, a.b[g++] =
						q, a.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2);
					f = Xl(a, [0, 0], u, v, p * Zl *
						(l || 1), f);
				...
				m ? v = z : (r = r || [0, 0], f = Xl(a, r, u, [0, 0], p * $l * (l || 1), f), f = Xl(a, r, u, [0, 0], -p * $l * (l ||
					1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f =
					Xl(a, r, u, [0, 0], p * am * l, f), f = Xl(a, r, u, [0, 0], -p * am * l, f), a.b[g++] = q + 2, a.b[g++] = q, a
					.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2));
				break
			...
			0 < e && (a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = 0 < p * A ? n :
				n - 1);
			a.b[g++] = q;
			a.b[g++] = q + 2;
			a.b[g++] = q + 1;
		...
		m && (q = q || f / 7, A = Mf([r[0], r[1], u[0], u[1], v[0], v[1]], 0, 6, 2) ? 1 : -1, f = Xl(a, r, u, v, A * bm * (
				h || 1), f), Xl(a, r, u, v, -A * dm * (h || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = q +
			1, a.b[g++] = q, a.b[g++] = 0 < p * A ? n : n - 1)
	}
	...
	k.uc = function(a, b) {
		var c = a.da();
		a = a.pa();
		fm(c, 0, c.length, a) && (c = Ue(c, 0, c.length, a, -this.origin[0], -this.origin[1]), this.c.u && (this.l.push(
			this.b.length), this.c.u = !1), this.g.push(this.b.length), this.i.push(b), Wl(this, c, c.length, a))
	};
	k.vc = function(a, b) {
		var c = this.b.length,
			d = a.pb();
	...
	function gm(a, b, c, d) {
		...
		if (c.length) {
			var e;
			b = 0;
			for (e = c.length; b < e; ++b) Rl(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])), Wl(a, c[b], c[
				b].length, d)
		}
	}
	...
	k.Oa = function(a, b) {
		...
		b = b.l;
		b = void 0 !== b ? b : 10;
		this.c.strokeColor && jc(this.c.strokeColor, a) && this.c.lineWidth === c && this.c.miterLimit === b || (this.c.u = !
			0, this.c.strokeColor = a, this.c.lineWidth = c, this.c.miterLimit = b,
			this.o.push([a, c, b]))
	};
	var Zl = 3,
		$l = 5,
	...
	function nm(a) {
		...
		if (b) {
			...
			d && (d.next = c);
			a.b = c || d;
			a.g === a.a ? (a.b = void 0, a.g = void 0, a.a = void 0) : a.g === b ? a.g = a.b : a.a === b && (a.a = d ? a.b.Eb :
				a.b);
			a.c--
		}
	}
	...
	function Cm(a, b, c, d, e, f) {
		...
		if (f === Mf(b, 0, b.length, c)) {
			...
			for (p = b.length - c, n = f = Im(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c) q = Im(a, b[p], b[p + 1],
					h++), m.push(Jm(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]),
				n = q;
		m.push(Jm(q, f, d));
	...
	function Em(a, b, c) {
		...
		do {
			...
			void 0 === h ? (Km(e, f, a, b), g = !0, f === d && (d = qm(a)), f = e, rm(a)) : e.X.Kb !== h && (e.X.Kb = h, g = !
				0);
			e = f;
			f = pm(a)
		} while (e !== d);
		...
		do {
			...
			if (!1 === r.Kb) {
				...
				!d && 0 !== Fm({
					Z: q,
					X: u
				}, c).length || !v || !d && !1 !== q.Kb && !1 !== u.Kb && Mf([h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x,
					n.X.y
				], 0, 10, 2) !== !e || (a.b[f++] = q.qb, a.b[f++] = r.qb, a.b[f++] = u.qb, Km(l, m, b, c), m === g && (g = n), p = !
					0)
			}
			h = sm(b);
			l = tm(b);
	...
	function Pm(a, b, c, d) {
		...
		do {
			...
			if (l) {
				...
				c.remove(n);
				var p = n === e;
				d ? (l[0] === f.Z.x && l[1] === f.Z.y ? (rm(b), l = f.Z, g.Z = l, c.remove(f), p = p || f === e) : (l = g.X, f.X =
					l, c.remove(g), p = p || g === e), nm(b)) : (l = Im(a, l[0], l[1], m), f.X = l, g.Z = l, vm(c, [Math.min(f.Z.x,
					f.X.x), Math.min(f.Z.y, f.X.y), Math.max(f.Z.x, f.X.x), Math.max(f.Z.y, f.X.y)], f), vm(c, [Math.min(g.Z.x, g.X
					.x), Math.min(g.Z.y, g.X.y), Math.max(g.Z.x, g.X.x), Math.max(g.Z.y,
					g.X.y)], g));
				a.b[h++] = n.Z.qb;
				a.b[h++] = n.X.qb;
				a.b[h++] = l.qb;
	...
	function Km(a, b, c, d) {
		tm(c) === b && (nm(c), a.X = b.X, d.remove(b), vm(d, [Math.min(a.Z.x, a.X.x), Math.min(a.Z.y, a.X.y), Math.max(a.Z.x,
			a.X.x), Math.max(a.Z.y, a.X.y)], a))
	}
	...
	function Mm(a, b, c, d, e) {
		...
		for (f = l.length; d < f; ++d)
			for (g in l[d]) {
				var m = l[d][g];
				"object" !== typeof m || e && !m.Kb || m.x === a.x && m.y === a.y || m.x === b.x && m.y === b.y || m.x === c.x &&
					m.y === c.y || -1 !== h.indexOf(m) || !Gf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, m.x, m.y) || h.push(m)
			}
		return h
	}
	...
	function Lm(a, b, c, d, e) {
		...
		if (0 !== f && (d = ((d.x - c.x) * (a.y - c.y) - (d.y - c.y) * (a.x - c.x)) / f, c = ((b.x - a.x) * (a.y - c.y) - (
					b.y - a.y) * (a.x - c.x)) / f, !e && d > xl && d < 1 - xl && c > xl && c < 1 - xl || e && 0 <= d && 1 >= d && 0 <=
				c && 1 >= c)) return [a.x + d * (b.x - a.x), a.y + d * (b.y - a.y)]
	}
	...
	Rm.prototype.add = function(a, b, c, d, e) {
		...
		for (f = this.a.length; g < f; ++g) {
			...
			if (h.width >= b + this.b && h.height >= c + this.b) return f = {
					...
					offsetY: h.y + this.b,
					image: this.i
				}, this.c[a] = f, d.call(e, this.g, h.x + this.b, h.y + this.b), a = g, b += this.b, d = c + this.b, h.width -
				b > h.height - d ? (c = {
					x: h.x + b,
					y: h.y,
					width: h.width - b,
	...
	function Wm(a, b, c, d, e, f, g) {
		...
		for (l = h.length; m < l; ++m) {
			...
			n || m !== l - 1 || (b ? (n = Math.min(2 * a.c, a.g), a.c = n) : (n = Math.min(2 * a.a, a.g), a.a = n), n = new Rm(
				n, a.b), h.push(n), ++l)
		}
		return null
	};
			...
			for (g = b.length; f < g; ++f) {
				...
				for (h = r.length; u < h; ++u) {
					...
					if (v) {
						...
						this.oa = A.height;
						this.qa = A.width;
						0 === this.c.length ? this.c.push(A) : (v = this.c[this.c.length - 1], x(v) != x(A) && (this.v.push(this.b.length),
							this.c.push(A)));
						v = c;
						z = d;
						var E = e;
	...
	k.nb = function(a) {
		...
		if (a && a.Ka() && (c || d)) {
			...
			d ? (c = d.a, b.strokeColor = zi(c ? c : vl), b.lineWidth = d.c || 1, b.lineCap = d.f || "round", b.lineDashOffset =
				d.i || 0, b.lineJoin = d.j || "round", b.miterLimit = d.l || 10, d = d.g, b.lineDash = d ? d.slice() : ul) : (b
				.strokeColor = null, b.lineWidth = 0);
			...
			e = c;
			this.B[e] || (a = this.Ub.getContext("2d"), a.font = b.font, a = Math.ceil((1.5 * a.measureText("M").width + b.lineWidth /
				2) * b.scale), this.B[e] = {
				Bh: new Tm({
					space: b.lineWidth + 1
				}),
	...
	mn.prototype.Zi = function(a, b, c) {
		...
		c.cd(e) && (d.enableVertexAttribArray(f.b), d.vertexAttribPointer(f.b, 2, 5126, !1, 16, 0), d.enableVertexAttribArray(
			f.a), d.vertexAttribPointer(f.a, 2, 5126, !1, 16, 8), d.uniform1i(f.i, 0));
	...
	pn.prototype.Bg = function(a, b) {
		...
		p[0] || p[1] || bb(q) || (b = n.Y(q, g, d, e.projection)) && Si(this, b) && (l = b, m = qn(this, b), this.Mb && a.postRenderFunctions
			.push(function(a, b) {
				a.isContextLost() || a.deleteTexture(b)
			}.bind(null, c, this.Mb)));
		l && (c = this.c.i.j, rn(this, c.width, c.height, d, f, g, h, l.G()), this.l = null, d = this.v, Xe(d), cf(d, 1, -
			1), df(d, 0,
		...
		if (this.M && this.M.Y())
			if (this.a.ha().wa !== ea) {
				...
				if (!(0 > a[0] || a[0] > e[0] || 0 > a[1] || a[1] > e[1]) && (this.i ||
						(this.i = hg(1, 1)), this.i.clearRect(0, 0, 1, 1), this.i.drawImage(this.M.Y(), a[0], a[1], 1, 1, 0, 0, 1, 1),
	...
	function tn(a, b, c, d) {
		var e = a.g,
			f = b.lb();
		if (a.a.a.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Mb), 9729 != a.hi && (e.texParameteri(3553,
			10240, 9729), a.hi = 9729), 9729 != a.ji && (e.texParameteri(3553, 10241, 9729), a.ji = 9729);
		else {
			...
			if (0 < d) {
				var h = a.C.canvas,
					l = a.C;
				a.D !== c[0] || a.N !== c[1] ? (h.width = c[0], h.height = c[1], a.D = c[0], a.N = c[1]) : l.clearRect(0, 0, c[0],
					c[1]);
	...
	k.Bg = function(a, b, c) {
		...
		if (this.l && na(this.l, E) && this.s == l.g) u = this.D;
			...
			for (xa = b.length; ia < xa; ++ia)
				for (Z in Va = c[b[ia]], Va) ta = Va[Z], Xa = m.Ma(ta.ya, la), ca[0] = 2 * (Xa[2] - Xa[0]) / S, ca[1] = 2 * (Xa[
						3] - Xa[1]) / S, ca[2] = 2 * (Xa[0] - u[0]) /
					S - 1, ca[3] = 2 * (Xa[1] - u[1]) / S - 1, e.uniform4fv(this.i.c, ca), tn(d, ta, q, v * r), e.drawArrays(5, 0,
						4);
		...
		Wi(a, l, m, r, g, A, n, h.c(), function(a) {
			2 != a.getState() || d.a.a.hasOwnProperty(a.lb()) || a.lb() in Zb.a || Zb.i([a, yc(m, a.ya), m.Ta(a.ya[0]), q,
				v * r
			])
		}, this);
		Ti(a, l);
	...
	k.Zi = function(a, b, c) {
		...
		var d = a.viewState,
			...
			g = a.pixelRatio,
			h = this.c.g;
		e && !e.yg() && (h.enable(h.SCISSOR_TEST), h.scissor(0, 0, f[0] * g, f[1] * g), e.Na(c, d.center, d.resolution, d.rotation,
			f, g, b.opacity, b.Te ? a.skippedFeatureUids : {}), h.disable(h.SCISSOR_TEST))
	};
	k.ia = function() {
		var a = this.i;
	...
	k.wa = function(a, b, c, d, e) {
		if (this.i && this.l) {
			...
			var f = this.a,
				g = {};
			return this.i.wa(a, this.c.i, c.center, c.resolution, c.rotation, b.size, b.pixelRatio, this.l.opacity, {},
				function(a) {
					var b = x(a).toString();
					if (!(b in g)) return g[b] = !0, d.call(e, a, f)
				})
	...
	k.km = function() {
		...
		var a = this.Ve();
		a && (this.c = y(a, "postrender", this.render, this), Hn(this), a = this.stopEvent ? a.v : a.o, this.insertFirst ?
			a.insertBefore(this.element, a.childNodes[0] || null) : a.appendChild(this.element))
	};
	k.render = function() {
		Hn(this)
	};
	...
	k.qm = function() {
		...
		if (this.get(Fn) && this.autoPan) {
			...
			if (a && a.Cc()) {
				...
				La(b, g) || (d = g[0] - b[0], e = b[2] - g[2], f = g[1] - b[1], g = b[3] - g[3], b = [0, 0], 0 > d ? b[0] = d -
					c : 0 > e && (b[0] = Math.abs(e) + c), 0 > f ? b[1] = f - c : 0 > g && (b[1] = Math.abs(g) + c), 0 ===
	...
	function Hn(a) {
		...
		if (b && b.c && c) {
			...
			var g = e[0];
			e = e[1];
			if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Se && (a.a.Se = b.left = ""), g =
				Math.round(d[0] - c[0] - g) + "px", a.a.xf != g && (a.a.xf = b.right = g);
			else {
			...
			if ("bottom-left" == f || "bottom-center" ==
				f || "bottom-right" == f) "" !== a.a.Ef && (a.a.Ef = b.top = ""), c = Math.round(d[1] - c[1] - e) + "px", a.a.ze !=
				c && (a.a.ze = b.bottom = c);
			else {
	...
	Mn.prototype.C = function(a) {
		a.preventDefault();
		On() && (a = this.a) && (Nn() ? document.exitFullscreen ? document.exitFullscreen() : document.msExitFullscreen ?
			document.msExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen &&
			document.webkitExitFullscreen() : (a = this.j ? "string" === typeof this.j ? document.getElementById(this.j) :
				this.j : a.Cc(), this.D ? a.mozRequestFullScreenWithKeys ? a.mozRequestFullScreenWithKeys() : a.webkitRequestFullscreen ?
	...
	function On() {
		var a = document.body;
		return !!(a.webkitRequestFullscreen || a.mozRequestFullScreen && document.mozFullScreenEnabled || a.msRequestFullscreen &&
	...
	var Qn = function() {
		...
		return function() {
			if (!a) {
				var b = document.body;
				b.webkitRequestFullscreen ? a = "webkitfullscreenchange" : b.mozRequestFullScreen ? a = "mozfullscreenchange" :
					b.msRequestFullscreen ? a = "MSFullscreenChange" : b.requestFullscreen && (a = "fullscreenchange")
			}
			return a
		}
	}();
	...
	function Wn(a) {
		...
		this.c.ye(this.v);
		e = document.createElement("div");
		e.className = d + " ol-unselectable ol-control" + (this.j && this.l ? " ol-collapsed" : "") + (this.l ? "" :
			" ol-uncollapsible");
	...
	k.setMap = function(a) {
		var b = this.a;
		a !== b && (b && ((b = b.aa()) && Mc(b, Xc("rotation"), this.Qe, this), this.c.Ad(null)), vg.prototype.setMap.call(
			this, a), a && (this.c.Ad(this.C), this.s.push(y(a, "propertychange", this.lm, this)), 0 === this.c.Xe().kc() &&
			this.c.zf(a.hc()), a = a.aa())) && (y(a, Xc("rotation"), this.Qe, this), ag(a) && (this.c.Oc(), Yn(this)))
	};
	k.lm = function(a) {
		"view" === a.key && ((a = a.oldValue) && Mc(a, Xc("rotation"), this.Qe, this), a = this.a.aa(), y(a, Xc("rotation"),
			this.Qe, this))
	};
	k.Qe = function() {
	...
	function Xn() {
		...
		if (a.c && b.c) {
			...
			f = d[0];
			d = d[1];
			b < .1 * f || e < .1 * d || b > .75 * f || e > .75 * d ? Yn(this) : La(c, a) || (a = this.c, c = this.a.aa(), a.aa()
				.ub(c.xa()))
		}
		Zn(this)
	}
	...
	function fo(a) {
		...
		if (b) {
			...
			var f = a.v * b;
			c = "";
			"degrees" == e ? (c = ub.degrees, "degrees" == d.a ? f *= c : b /= c, f < c / 60 ? (c = "\u2033", b *= 3600) : f <
					c ? (c = "\u2032", b *= 60) : c = "\u00b0") : "imperial" == e ? .9144 > f ? (c = "in", b /= .0254) : 1609.344 >
				f ? (c = "ft", b /= .3048) : (c = "mi", b /= 1609.344) : "nautical" == e ? (b /= 1852, c = "nm") : "metric" == e ?
				.001 > f ? (c = "\u03bcm", b *= 1E6) : 1 > f ? (c = "mm", b *= 1E3) : 1E3 > f ? c = "m" : (c = "km", b /= 1E3) :
				"us" == e ? .9144 > f ?
	...
	k.$l = function(a) {
		this.o || a.b.target !== this.element.firstElementChild || (bg(this.a.aa(), 1, 1), this.C = a.clientX, this.B = a.clientY,
			this.o = !0)
	};
	k.Yl = function(a) {
		if (this.o) {
			var b = this.element.firstElementChild;
			this.c = ko(this, pa(1 === this.j ? (a.clientX - this.C + parseInt(b.style.left, 10)) / this.D : (a.clientY -
				this.B + parseInt(b.style.top, 10)) / this.v, 0, 1));
			this.a.aa().gd(this.c);
			jo(this, this.c);
			this.C = a.clientX;
			this.B = a.clientY
	...
	function zo(a, b, c, d, e, f) {
		for (var g = (void 0 !== e ? e : c).length, h, l, m = 0; m < g; ++m) h = c[m], void 0 !== h && (l = b.call(f, h, d,
			void 0 !== e ? e[m] : void 0), void 0 !== l && a[l.namespaceURI][l.localName].call(f, l, h, d))
	}
	...
	k.Wn = function(a, b, c) {
		return "XYM" != this.ja && "XYZM" != this.ja || 0 === this.A.length ? null : Tk(this.A, this.c, this.a, a, void 0 !==
			b ? b : !1, void 0 !== c ? c : !1)
	};
	k.W = function() {
	...
	function Qo(a, b) {
		...
		if ("number" === typeof a.x && "number" === typeof a.y) var c = "Point";
			...
			var h;
			var l = 0;
			for (h = d.length; l < h; ++l) f.length = 0, wf(f, 0, d[l], e.length), Mf(f, 0, f.length, e.length) ? g.push([d[l]]) :
				c.push(d[l]);
			for (; c.length;) {
				d = c.shift();
				e = !1;
	...
	var So = {
			Point: function(a) {
				return void 0 !== a.m && void 0 !== a.z ? new C([a.x, a.y, a.z, a.m], "XYZM") : void 0 !== a.z ? new C([a.x, a.y,
					a.z
				], "XYZ") : void 0 !== a.m ? new C([a.x, a.y, a.m], "XYM") : new C([a.x, a.y])
			},
	...
	k.ge = function(a, b) {
		var c = a.localName,
			d = null;
		if ("FeatureCollection" == c) "http://www.opengis.net/wfs" === a.namespaceURI ? d = O([], this.b, a, b, this) : d =
			...
			for (var u in g) {
				n = {};
				l = 0;
				for (h = f.length; l < h; ++l)(-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u && (n[f[l].split(":")
					.pop()] = "featureMembers" == c ? uo(this.Kg, this) : vo(this.Kg, this));
				e[g[u]] = n
			}
	...
	function Kp(a) {
		...
		this.schemaLocation = a.schemaLocation ? a.schemaLocation :
	...
	k.Pg = function(a, b) {
		...
		c = c.split(/\s+/);
		d = 2;
		a.getAttribute("srsDimension") ? d = gp(a.getAttribute("srsDimension")) : a.getAttribute("dimension") ? d = gp(a.getAttribute(
				"dimension")) : a.parentNode.getAttribute("srsDimension") ? d = gp(a.parentNode.getAttribute("srsDimension")) :
			e && (d = gp(e));
		for (var f, g = [], h = 0, l = c.length; h < l; h += d) a = parseFloat(c[h]), e = parseFloat(c[h + 1]), f = 3 ===
			d ? parseFloat(c[h + 2]) : 0, "en" === b.substr(0,
	...
	k.af = function(a, b, c) {
		...
		"Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Ud(), Do({
			...
			hasZ: e,
			srsName: d
		}, Np, this.On, b, c, void 0, this)) : "Surface" === a.nodeName && (e = no(a.namespaceURI, "patches"), a.appendChild(
			e), a = no(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.af(a, b, c))
	};
	k.$e = function(a, b, c) {
		var d = c[c.length - 1].srsName;
		"LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
		"LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = no(a.namespaceURI, "posList"), a.appendChild(
			d), Lp(d, b, c)) : "Curve" === a.nodeName && (d = no(a.namespaceURI, "segments"), a.appendChild(d), a = no(d.namespaceURI,
			"LineStringSegment"), d.appendChild(a), this.$e(a, b, c))
	};
	k.Gi = function(a, b, c) {
		var d = c[c.length - 1],
			e = d.hasZ,
	...
	k.Ci = function(a, b, c) {
		...
		for (m in g) {
			var l = g[m];
			null !== l && (b.push(m), h.push(l), m == f || l instanceof gf ? m in d.tb[e] || (d.tb[e][m] = M(this.Yc, this)) :
	...
	Kp.prototype.a = function(a, b) {
		...
		var d = c.surface,
			e = c.curve;
		c = c.multiCurve;
		Array.isArray(a) ? a = "Envelope" : (a = a.S(), "MultiPolygon" === a && !0 === b ? a = "MultiSurface" : "Polygon" ===
			a && !0 === d ? a = "Surface" : "LineString" === a && !0 === e ? a = "Curve" : "MultiLineString" === a && !0 ===
			c && (a = "MultiCurve"));
	...
	k.uj = function(a, b) {
		...
		c && (c = Ob(c)) && (b = c.b);
		a = a.trim().split(/\s+/);
		for (var d, e, f = [], g = 0, h = a.length; g < h; g++) e = a[g].split(/,+/), c = parseFloat(e[0]), d = parseFloat(
			e[1]), e = 3 === e.length ? parseFloat(e[2]) : 0, "en" === b.substr(0, 2) ? f.push(c, d, e) : f.push(d, c, e);
		return f
	};
	k.Up = function(a, b) {
	...
	k.wg = function(a, b) {
		...
		c = c.multiCurve;
		Array.isArray(a) ? a = "Envelope" : (a = a.S(), "MultiPolygon" === a && !0 === b ? a = "MultiSurface" : "Polygon" ===
			a && !0 === d ? a = "Surface" : "MultiLineString" === a && !0 === c && (a = "MultiCurve"));
		return no("http://www.opengis.net/gml", a)
	};
	k.ui = function(a, b, c) {
		var d = c[c.length - 1],
	...
	k.Ye = function(a, b, c) {
		var d = c[c.length - 1].srsName;
		"LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
		"LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = Vp(a.namespaceURI), a.appendChild(d), Wp(
			d, b, c)) : "Curve" === a.nodeName && (d = no(a.namespaceURI, "segments"), a.appendChild(d), a = no(d.namespaceURI,
			"LineStringSegment"), d.appendChild(a), this.Ye(a, b, c))
	};
	...
	k.Ze = function(a, b, c) {
		...
		"Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Ud(), Do({
			...
			hasZ: e,
			srsName: d
		}, Yp, this.Kn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = no(a.namespaceURI, "patches"), a.appendChild(
			e), a = no(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Ze(a, b, c))
	};
	k.Kn = function(a, b) {
		a = b[b.length - 1];
		b = a.node;
	...
	function gq(a, b, c) {
		...
		if (4 !== e) {
			var f;
			var g = 0;
			for (f = b.length / 4; g < f; g++) b[g * e] = b[4 * g], b[g * e + 1] = b[4 * g + 1], a.hasZ && (b[g * e + 2] = b[4 *
				g + 2]), a.hasM && (b[g * e + 2] = b[4 * g + 3]);
	...
	var yq = ["text", "type"],
		...
		Cq = N(eq, {
			...
			time: M(function(a, b) {
				b = new Date(1E3 * b);
				a.appendChild(mo.createTextNode(b.getUTCFullYear() + "-" + xe(b.getUTCMonth() + 1) + "-" + xe(b.getUTCDate()) +
					"T" + xe(b.getUTCHours()) + ":" + xe(b.getUTCMinutes()) + ":" + xe(b.getUTCSeconds()) + "Z"))
			}),
			magvar: M(Ip),
			geoidheight: M(Ip),
			name: M(ip),
	...
	dq.prototype.bc = function(a, b) {
		...
		c.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:schemaLocation",
	...
	k.fe = function(a, b) {
		...
		for (m = d.length; n < m; ++n) {
			...
			} else "H" == p.charAt(0) && ((q = $q.exec(p)) ? (h = parseInt(q[1], 10), g = parseInt(q[2], 10) - 1, f = 2E3 +
				parseInt(q[3], 10)) : (q = Zq.exec(p)) && (a[q[1]] = q[2].trim()))
		}
	...
	br.prototype.o = function() {
		...
		if (!this.s && null !== this.f) {
			...
			for (var b = a.getImageData(0, 0, this.M.width, this.M.height), c = b.data, d = this.f[0] / 255, e = this.f[1] /
					255, f = this.f[2] / 255, g = 0, h = c.length; g < h; g += 4) c[g] *= d, c[g + 1] *= e, c[g + 2] *= f;
	...
	function er(a) {
		...
		fr || (gr = [255, 255, 255, 1], hr = new zk({
				color: gr
			}), ir = [20, 2], jr = kr = "pixels", lr = [64, 64], mr =
			"https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", nr = .5, or = new dr({
				anchor: ir,
	...
	var ur = ["http://www.google.com/kml/ext/2.2"],
		vr = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2",
	...
	function xr(a, b) {
		...
		null !== a.Ka() ? (e = a.Ka(), a = e.clone(), a.Jj(e.a || sr.a), a.lj(e.b || sr.b), a.yf(e.Fa() || sr.Fa()), a.Af(e
			.Ga() || rr)) : a = sr.clone();
		a.Hd(b);
		a.Nj(c[0]);
		a.Oj(c[1]);
	...
	function zr(a, b, c) {
		return Array.isArray(a) ? a : "string" === typeof a ? (!(a in c) && "#" + a in c && (a = "#" + a), zr(c[a], b, c)) :
			b
	}

	function Ar(a) {
		a = oo(a, !1);
		if (a = /^\s*#?\s*([0-9A-Fa-f]{8})\s*$/.exec(a)) return a = a[1], [parseInt(a.substr(6, 2), 16), parseInt(a.substr(
			4, 2), 16), parseInt(a.substr(2, 2), 16), parseInt(a.substr(0, 2), 16) / 255]
	}
	...
	function Mr(a, b) {
		...
		for (e = a.length; f < e; ++f)
			...
			if ("Point" == d) {
				...
				g.ba(c, d);
				Or(g, a)
			} else "LineString" == d ? (g = new P(null), Mo(g, a), Or(g, a)) : "Polygon" == d ? (g = new Q(null), Oo(g, a), Or(
				g, a)) : "GeometryCollection" == d ? g = new Mq(a) : oa(!1, 37);
		else g = new Mq(a);
		return g
	}
	...
	var Yr = N(vr, {
		...
		Xr = N(vr, {
			LatLonAltBox: function(a, b) {
				if (a = O({}, $r, a, b)) b = b[b.length - 1], b.extent = [parseFloat(a.west), parseFloat(a.south), parseFloat(a
						.east), parseFloat(a.north)], b.altitudeMode = a.altitudeMode, b.minAltitude = parseFloat(a.minAltitude), b.maxAltitude =
					parseFloat(a.maxAltitude)
			},
			Lod: function(a, b) {
				if (a = O({}, as, a, b)) b = b[b.length - 1], b.minLodPixels = parseFloat(a.minLodPixels), b.maxLodPixels =
					parseFloat(a.maxLodPixels), b.minFadeExtent = parseFloat(a.minFadeExtent), b.maxFadeExtent = parseFloat(a.maxFadeExtent)
			}
		}),
		$r = N(vr, {
			altitudeMode: L(R),
		...
		Hr = N(vr, {
			...
			coord: function(a, b) {
				...
				(a =
					...
					.exec(a)) ? b.push(parseFloat(a[1]), parseFloat(a[2]), parseFloat(a[3]),
					0): b.push(0, 0, 0, 0)
			}
		})),
		Kr = N(vr, {
		...
		es = N(vr, {
			...
			hotSpot: L(function(a) {
				...
				var d = "insetPixels" !== b ? "insetPixels" !== c ? "bottom-left" : "top-left" : "insetPixels" !== c ?
		...
		ms = N(vr, {
			...
			StyleMap: function(a, b) {
				if (a = O(void 0, ls, a, b)) b = b[b.length - 1], Array.isArray(a) ? b.Style = a : "string" === typeof a ? b.styleUrl =
					a : oa(!1, 38)
			},
			address: L(R),
			description: L(R),
			...
			IconStyle: function(a, b) {
				if (a = O({}, es, a, b)) {
					...
					if (g) {
						...
						var m = g.ph;
						f = g.origin
					} else e === mr ? (h = ir, l = kr, m = jr) : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) && (h = [.5,
						0
					], m = l = "fraction");
					var n;
					g = c.x;
	...
	k.kq = function(a, b) {
		...
		null !== c && (b = Sr(a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href), c = a ? (
			new URL("#" + c, a)).href : "#" + c, this.b[c] = b)
	};
	k.jq = function(a, b) {
		var c = a.getAttribute("id");
		null !== c && (b = O(void 0, ls, a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href),
	...
	function ps(a, b) {
		...
		for (c = b.firstElementChild; c; c = c.nextElementSibling)
			if (b = c.localName, ec(vr, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) &&
				(b = ps(a, c))) return b
	}
	k.eq = function(a) {
		var b = [];
	...
	function rs(a, b) {
		...
		for (c = b.firstElementChild; c; c = c.nextElementSibling)
			if (ec(vr, c.namespaceURI) && "NetworkLink" == c.localName) {
				var e = O({}, js, c, []);
				d.push(e)
			} for (c = b.firstElementChild; c; c = c.nextElementSibling) b = c.localName, !ec(vr, c.namespaceURI) ||
			"Document" != b && "Folder" != b && "kml" != b || gc(d, rs(a, c));
		return d
	}
	k.hq = function(a) {
		var b = [];
	...
	k.vf = function(a) {
		...
		for (b = a.firstElementChild; b; b = b.nextElementSibling)
			if (ec(vr, b.namespaceURI) && "Region" == b.localName) {
				var d = O({}, Xr, b, []);
				c.push(d)
			} for (b = a.firstElementChild; b; b = b.nextElementSibling) a = b.localName, !ec(vr, b.namespaceURI) ||
			"Document" != a && "Folder" != a && "kml" != a || gc(c, this.vf(b));
		return c
	};
	...
	function us(a, b, c) {
		...
		if ("GeometryCollection" == d) {
			var e = b.vd();
			var f = vs
		} else "MultiPoint" == d ? (e = b.de(), f = ws) : "MultiLineString" == d ? (e = b.wd(), f = xs) : "MultiPolygon" ==
			d ? (e = b.Vd(), f = ys) : oa(!1, 39);
		Do(a, zs, f, e, c)
	}
		...
		var e = {
			...
			write: function(a, b, c, d, e, n) {
				...
				var z = d ? 1 : -1,
					A = 0 > b || 0 === b && 0 > 1 / b ? 1 : 0;
				b = Math.abs(b);
				isNaN(b) || Infinity === b ? (b = isNaN(b) ? 1 : 0, d = h) : (d = Math.floor(Math.log(b) / Math.LN2), 1 > b *
					(f = Math.pow(2, -d)) && (d--, f *= 2), b = 1 <= d + l ? b + m / f : b + m * Math.pow(2, 1 - l), 2 <= b * f &&
					(d++, f /= 2), d + l >= h ? (b = 0, d = h) : 1 <= d + l ? (b = (b * f - 1) * Math.pow(2, e), d += l) : (b =
						b * Math.pow(2, l - 1) * Math.pow(2, e), d = 0));
			...
			Vg: function() {
				for (var a = this.Ua() + this.ga, b = this.tc, c = "", d = this.ga; d < a;) {
					...
					if (1 === p) 128 > e && (n = e);
						...
						r = b[d + 2];
						var u = b[d + 3];
						128 === (q & 192) && 128 === (r & 192) && 128 === (u & 192) && (n = (e & 15) << 18 | (q & 63) << 12 | (r &
							63) << 6 | u & 63, 65535 >= n || 1114112 <= n) && (n = null)
					}
	...
	function lt(a, b, c) {
		if (15 === a) b.version = c.Ua();
			...
			a = null;
			for (var d = c.Ua() + c.ga; c.ga < d;) a = c.Ua() >> 3, a = 1 === a ? c.Vg() : 2 === a ? c.Zp() : 3 === a ? c.Vp() :
				4 === a ? c.lq() : 5 === a ? c.Ua() : 6 === a ? c.Ug() : 7 === a ? c.Tp() : null;
			b.values.push(a)
		}
	}
	...
	function nt(a, b, c) {
		...
		b.ga = c.geometry;
		c = b.Ua() + b.ga;
		for (var m = 1, n = 0, p = 0, q = 0, r = 0, u = 0; b.ga < c;) n || (n = b.Ua(), m = n & 7, n >>= 3), n--, 1 === m ||
			2 === m ? (p += b.Ug(), q += b.Ug(), 1 === m && r > u && (l.push(r), u = r), g.push(p, q), r += 2) : 7 === m ? r >
			u && (g.push(g[u], g[u + 1]), r += 2) : oa(!1, 59);
		r > u && l.push(r);
		b = h.length;
		var v;
		1 === d ? v = 1 === b ? "Point" : "MultiPoint" : 2 === d ? v = 1 === b ? "LineString" : "MultiLineString" : 3 ===
			d && (v = "Polygon");
		d = v;
		if (a.b === it) g = new a.b(d,
			...
			} else d = "Point" === d ? new C(null) : "LineString" === d ? new I(null) : "Polygon" === d ? new D(null) :
				"MultiPoint" === d ? new No(null) : "MultiLineString" === d ? new P(null) : null;
			d.ba("XY", g, h);
			g = new a.b;
			a.g && g.Lc(a.g);
	...
	At.prototype.Mg = function(a, b) {
		if ("Topology" == a.type) {
			...
			a = a.objects;
			g = this.a;
			for (var A in a) this.b && -1 == this.b.indexOf(A) || ("GeometryCollection" === a[A].type ? (l = a[A], e.push.apply(
				e, Ct(l, f, c, d, g, A, b))) : (l = a[A], e.push(Dt(l, f, c, d, g, A, b))));
			return e
		}
		return []
	};
		...
		"http://www.opengis.net/wfs": {
			Insert: M(function(a, b, c) {
				...
				if (2 === e) {
					...
					for (n in h) {
						var m = h[n];
						null !== m && (b.push(n), l.push(m), n == g || m instanceof gf ? n in e.tb[f] || (e.tb[f][n] = M(a.ui, a)) :
			...
			Property: M(function(a, b, c) {
				...
				a.appendChild(d);
				ip(d, b.name);
				void 0 !== b.value && null !== b.value && (d = no("http://www.opengis.net/wfs", "Value"), a.appendChild(d), b.value instanceof gf ?
					2 === e ? Tp.prototype.ui(d, b.value, c) : Kp.prototype.Yc(d,
	...
	function Uu(a) {
		...
		if ("(" == b) c.type = 2;
			...
			} while ("0" <= f && "9" >= f || "." == f && (void 0 === d || !d) || !e && ("e" == f || "E" == f) || e && ("-" ==
					f || "+" == f));
	...
	function Tu(a) {
		...
		if (Vu(a, 1)) {
			...
			var c = "XY",
				d = a.b;
			1 == a.b.type && (d = d.value, "Z" === d ? c = "XYZ" : "M" === d ? c = "XYM" : "ZM" === d && (c = "XYZM"), "XY" !==
				c && Su(a));
			a.a = c;
	...
	var nv = [null, "http://www.opengis.net/wms"],
		...
		sv = N(nv, {
			...
			BoundingBox: wo(function(a) {
				var b = [ep(a.getAttribute("minx")), ep(a.getAttribute("miny")), ep(a.getAttribute("maxx")), ep(a.getAttribute(
						"maxy"))],
			...
			Layer: wo(function(a, b) {
				var c = b[b.length - 1],
					d = O({}, sv, a, b);
				if (d) return b = bp(a.getAttribute("queryable")), void 0 === b && (b = c.queryable), d.queryable = void 0 !==
					b ? b : !1, b = gp(a.getAttribute("cascaded")), void 0 === b && (b = c.cascaded), d.cascaded = b, b = bp(a.getAttribute(
						"opaque")), void 0 === b && (b = c.opaque), d.opaque = void 0 !== b ? b : !1, b = bp(a.getAttribute(
						"noSubsets")), void 0 === b && (b = c.noSubsets), d.noSubsets =
					void 0 !== b ? b : !1, (b = ep(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth), d.fixedWidth = b, (a =
						ep(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight), d.fixedHeight = a, ["Style", "CRS",
						"AuthorityURL"
					].forEach(function(a) {
	...
	k.$a = function(a) {
		var b = this.G();
		return hb(a, b) ? (b = this.xa(), a[0] <= b[0] && a[2] >= b[0] || a[1] <= b[1] && a[3] >= b[1] ? !0 : Ua(a, this.Bb,
			this)) : !1
	};
	k.ub = function(a) {
		var b = this.a,
	...
	function nw(a) {
		var b = a.v;
		b && (b = a.target ? a.target : b.a, a.a = [y(b, "drop", jw, a), y(b, "dragenter", kw, a), y(b, "dragover", kw, a),
			y(b, "drop", kw, a)
		])
	}
	...
	function xw(a, b) {
		...
		g = 0;
		for (c = e.length; g < c; g++) h = e[g], l = x(h).toString(), Aw(a, l, h), (b = h.U()) ? (l = b.G(), d.push(l), f.push(
			h)) : a.f[l] = h;
		a.a && a.a.load(d, f);
		g = 0;
	...
	k.gj = function(a) {
		...
		var b = x(a).toString(),
			c = a.U();
		c ? (c = c.G(), b in this.f ? (delete this.f[b], this.a && this.a.Ca(c, a)) : this.a && vm(this.a, c, a)) : b in
			this.f || (this.a && this.a.remove(a), this.f[b] = a);
		c = a.c;
		void 0 !== c ? (c = c.toString(), b in this.l ? (delete this.l[b], this.j[c] = a) : this.j[c] !== a && (Dw(this, a),
			this.j[c] = a)) : b in this.l || (Dw(this, a), this.l[b] = a);
		this.u();
	...
	function Gw(a) {
		...
		var b = !0;
		this.o && "pointerdrag" === a.type && null !== this.j ? (Nw(this, a), b = !1) : this.o && "pointerdown" === a.type ?
			b = !1 : "pointermove" === a.type ? b = Ow(this, a) : "dblclick" === a.type && (b = !1);
	...
	function Hw(a) {
		...
		this.V ? (this.s ? this.o || c ? this.Pd() : Rw(this, a) ? this.Md(a) && this.Pd() : Nw(this, a) : (Pw(this, a),
			this.f === Kw && this.Pd()), b = !1) : this.o && (this.s = null, Sw(this));
	...
	function Ow(a, b) {
		...
		a.s ? (e = b.coordinate, c = a.j.U(), a.f === Kw ? d = a.a : a.f === Jw ? (d = a.a[0], d = d[d.length - 1], Rw(a, b) &&
				(e = a.s.slice())) : (d = a.a, d = d[d.length - 1]), d[0] = e[0], d[1] = e[1], a.cb(a.a, c), a.B && a.B.U().na(e),
			c instanceof D && a.f !== Jw ? (a.C || (a.C = new Hk(new I(null))), e = c.Wh(0), b = a.C.U(), b.ba(e.ja, e.da())) :
			a.T && (b = a.C.U(), b.na(a.T)), Tw(a)) : (b = b.coordinate.slice(), a.B ? a.B.U().na(b) : (a.B = new Hk(new C(b)),
			Tw(a)));
		return !0
	}
	...
	function Rw(a, b) {
		...
		if (a.j) {
			var d = !1,
				e = [a.s];
			a.f === Lw ? d = a.a.length > a.Ea : a.f === Jw && (d = a.a[0].length > a.Ea, e = [a.a[0][0], a.a[0][a.a[0].length -
				2
			]]);
			if (d) {
				d = b.map;
	...
	function Nw(a, b) {
		...
		if (a.f === Lw) {
			...
			e.push(b.slice());
			a.cb(e, c)
		} else a.f === Jw && (e = a.a[0], e.length >= a.ua && (a.o ? e.pop() : d = !0), e.push(b.slice()), d && (a.s = e[0]),
			a.cb(a.a, c));
		Tw(a);
		d && a.Pd()
	}
	...
	k.Pd = function() {
		...
		"MultiPoint" === this.O ? a.Va(new No([b])) : "MultiLineString" === this.O ? a.Va(new P([b])) : "MultiPolygon" ===
			this.O && a.Va(new Q([b]));
	...
	function Iw(a) {
		var b;
		"Point" === a || "MultiPoint" === a ? b = Kw : "LineString" === a || "MultiLineString" === a ? b = Lw : "Polygon" ===
			a || "MultiPolygon" === a ? b = Jw : "Circle" === a && (b = Qw);
		return b
	}
	var Kw = "Point",
		Lw = "LineString",
	...
	function Ww(a) {
		...
		var c = a.pixel,
			d = a.map,
			e = this.G();
		(a = bx(this, c, d)) && e ? (c = a[0] == e[0] || a[0] == e[2] ? a[0] : null, d = a[1] == e[1] || a[1] == e[3] ? a[1] :
			null, null !== c && null !== d ? this.a = dx(b(a)) : null !== c ? this.a = ex(b([c, e[1]]), b([c, e[3]])) : null !==
			d && (this.a = ex(b([e[0], d]), b([e[2], d])))) : (a = d.Ra(c), this.f([a[0], a[1], a[0], a[1]]), this.a = dx(a));
		return !0
	}
	...
	function bx(a, b, c) {
		...
		if (f) {
			...
			var g = Be(e, f),
				h = c.Ia(g);
			if (Ie(b, h) <= a.C) return b = c.Ia(f[0]), c = c.Ia(f[1]), b = He(h, b), c = He(h, c), a.B = Math.sqrt(Math.min(b,
				c)) <= a.C, a.B && (g = b > c ? f[1] : f[0]), g
		}
		return null
	}
	...
	function gx(a) {
		...
		this.V = null;
		a.source ? (this.V = a.source, a = new B(this.V.ee()), y(this.V, "addfeature", this.vm, this), y(this.V,
			"removefeature", this.xm, this)) : a = a.features;
	...
	function hx(a) {
		...
		if (c) {
			...
			for (var g = 0, h = e.length; g < h; ++g) {
				...
				p && (n += "-" + p.join("-"));
				f[n] || (f[n] = Array(2));
				if ("Circle" === l.geometry.S() && 1 === l.index) m = tx(b, l), Ee(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n]
					[0] = l);
		...
		if (0 < f.length) {
			...
			if (n <= a.ra) {
				...
				if ("Circle" === g.geometry.S() && 1 === g.index) a.ua = !0, rx(a, l);
					...
					for (n = c.Ia(h[0]), g = c.Ia(h[1]), c = He(m, n), m = He(m, g), n = Math.sqrt(Math.min(c, m)), a.ua = n <= a.ra,
						a.ua && (l = c > m ? h[1] : h[0]), rx(a, l), m = 1, c = f.length; m < c; ++m)
			...
			for (h in c) {
				...
				switch (f.S()) {
					...
					case "MultiPolygon":
						p = p[g.depth[1]];
					case "Polygon":
						p = p[g.depth[0]], 4 < p.length && (e == p.length - 1 && (e = 0), p.splice(e, 1), q = !0, 0 === e && (p.pop(),
							p.push(p[0]), n = p.length - 1))
				}
				q && (q = f, this.s = !0, q.na(d), this.s = !1, d = [], void 0 !== m && (this.a.remove(m), d.push(m.ma[0])),
					void 0 !== l && (this.a.remove(l), d.push(l.ma[1])), void 0 !== m && void 0 !== l && (m = {
						depth: g.depth,
						feature: g.feature,
						geometry: g.geometry,
						index: n,
	...
	k.setMap = function(a) {
		...
		fh.prototype.setMap.call(this, a);
		a && (this.j ? c.push(y(this.j, "add", this.Ni, this), y(this.j, "remove", this.Oi, this)) : this.s && c.push(y(
			this.s, "addfeature", this.Ni, this), y(this.s, "removefeature", this.Oi, this)), d.forEach(this.bl, this))
	};
	k.jd = Se;
	...
	function Fx(a, b, c, d) {
		...
		if (0 < g.length) {
			...
			if (a.O && !a.C) {
				if (c = d.Ia(m[0]), h = d.Ia(m[1]), c = He(b, c), b = He(b, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.f) e = !
					0, f = c > b ? m[1] : m[0], l = d.Ia(f)
			} else a.C && (f = h ? Ae(c, g[0].feature.U()) : Be(c, m), l = d.Ia(f), Ie(b, l) <= a.f && (e = !0, a.O &&
				!h && (c = d.Ia(m[0]), h = d.Ia(m[1]), c = He(l, c), b = He(l, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.f)
	...
	function Jx(a) {
		var b = a.map.a;
		Lx(this, a.pixel, a.map) ? (b.classList.remove(this.a ? "ol-grab" : "ol-grabbing"), b.classList.add(this.a ?
			"ol-grabbing" : "ol-grab")) : b.classList.remove("ol-grab", "ol-grabbing")
	}
	...
	k.cm = function() {
		for (var a = this.Uh(), b = hg(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f =
				a.length; e < f; ++e) c.addColorStop(e * d, a[e]);
		b.fillStyle = c;
	...
	function dy(a, b, c, d, e, f, g, h, l, m, n) {
		...
		var r = hg(Math.round(c * cb(q) / d), Math.round(c * db(q) / d)),
			u = c / d;
		l.forEach(function(a) {
			r.drawImage(a.image, m, m, a.image.width - 2 * m, a.image.height - 2 * m, (a.extent[0] - q[0]) * u, -(a.extent[3] -
				q[3]) * u, cb(a.extent) * u, db(a.extent) * u)
		});
		var v = $a(g);
		h.c.forEach(function(a) {
			...
			g && (p.save(), p.beginPath(), l = (a + u + Va) / 3, m = (n + z + ic) / 3, h = cy(l, m, a, n), u = cy(l, m, u, z),
				Va = cy(l, m, Va, ic), p.moveTo(u[0], u[1]), p.lineTo(h[0], h[1]), p.lineTo(Va[0], Va[1]), p.clip(), p.transform(
					g[0], g[2], g[1], g[3], a, n), p.translate(q[0] - e, q[3] - b), p.scale(d / c, -d / c), p.drawImage(r.canvas,
					0, 0), p.restore())
		});
	...
	function fy(a, b, c, d, e, f, g, h, l, m) {
		...
		if (u || !a.f || hb(n, a.f)) {
			if (!(u || isFinite(f[0]) && isFinite(f[1]) && isFinite(g[0]) && isFinite(g[1]) && isFinite(h[0]) && isFinite(h[1]) &&
					isFinite(l[0]) && isFinite(l[1])))
				if (0 < m) u = !0;
				else return;
			if (0 < m && (u || (n = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2]), q = r ? (wa(f[0], q) + wa(h[0], q)) / 2 - wa(
						n[0], q) : (f[0] + h[0]) / 2 - n[0], n = (f[1] + h[1]) / 2 - n[1],
					u = q * q + n * n > a.v), u)) {
				Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1]) ? (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], q = a.a(r), n = [(e[
					0] + b[0]) / 2, (e[1] + b[1]) / 2], p = a.a(n), fy(a, b, c, r, n, f, g, q, p, m - 1), fy(a, n, r, d, e, p, q,
					h, l, m - 1)) : (r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2], q = a.a(r), n = [(d[0] + e[0]) / 2, (d[1] + e[1]) /
					2
	...
	function Li(a, b, c, d, e) {
		...
		for (var f, g, h = d.fa; h <= d.la; ++h)
			for (var l = d.ea; l <= d.ka; ++l) f = c + "/" + h + "/" + l, g = !1, a.a.hasOwnProperty(f) && (f = a.get(f), (g =
				2 === f.getState()) && (g = !1 !== e(f))), g || (b = !1);
		return b
	}
	k.Zf = function() {
		return 0
	...
	k.eb = function(a) {
		var b = this.c;
		return !this.tileGrid || b && !Xb(b, a) ? (b = x(a).toString(), b in this.s || (this.s[b] = zc(a)), this.s[b]) :
			this.tileGrid
	};
	k.Yd = function(a) {
		var b = this.c;
	...
	function ry(a) {
		...
		Zx("https://dev.virtualearth.net/REST/v1/Imagery/Metadata/" +
			this.B + "?uriScheme=https&include=ImageryProviders&key=" + this.l + "&c=" + this.o, this.La.bind(this), void 0,
			"jsonp")
	}
	w(ry, ny);
	...
	ry.prototype.La = function(a) {
		if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 !=
			a.resourceSets.length || 1 != a.resourceSets[0].resources.length) ww(this, "error");
		else {
			...
			this.tileUrlFunction = Wx(c.imageUrlSubdomains.map(function(a) {
				...
				return function(a) {
					if (a) return oc(a[0], a[1], -a[2] - 1, b), a = d, f && (a += "&dpi=d1&device=mobile"), a.replace(
						"{quadkey}", pc(b))
				}
			}));
	...
	function wy(a) {
		if (void 0 !== a.resolution) {
			...
			for (var b = Da(), c = a.distance * a.resolution, d = a.source.ee(), e = {}, f = 0, g = d.length; f < g; f++) {
				var h = d[f];
				x(h).toString() in e || !(h = a.geometryFunction(h)) || (h = h.W(), Pa(h, b), Fa(b, c, b), h = a.source.Yf(b), h =
					h.filter(function(a) {
						a = x(a).toString();
	...
	yy.prototype.he = function() {
		...
		2 == a && (this.i = dy(cb(this.g) / this.c, db(this.g) / this.c, this.j, this.Tb.resolution, 0, this.c, this.g,
			this.f, [{
				extent: this.Tb.G(),
				image: this.Tb.Y()
			}], 0));
	...
	k.Mk = function(a, b, c, d, e) {
		...
		Zj(f);
		if (g) return null;
		this.l[0] != d[0] || this.l[1] != d[1] ? (this.f.canvas.width = d[0], this.f.canvas.height = d[1], this.l[0] = d[0],
	...
	function Ry(a) {
		a = a || {};
		var b;
		void 0 !== a.attributions ? b = a.attributions : b = [
	...
	(function(a) {
		...
		function d(a, b) {
			...
			}).concat(["var __minion__ = (" + c.toString() + ")(", a.operation.toString(), ");",
	...
	cz.prototype.dc = function(a, b, c) {
		...
		if (!(d.b.length <= a[0])) {
			...
			kb(d, this.i);
			var g = this.urls;
			g ? (c = c.wb.split(":").pop(), d.SIZE = f[0] + "," + f[1], d.BBOX = e.join(","), d.BBOXSR = c, d.IMAGESR = c, d.DPI =
				Math.round(d.DPI ? d.DPI * b : 90 * b), a = (1 == g.length ? g[0] : g[wa((a[1] << a[0]) + a[2], g.length)]).replace(
					/MapServer\/?$/, "MapServer/export").replace(/ImageServer\/?$/, "ImageServer/exportImage"),
				a = Gy(a, d)) : a = void 0;
			return a
		}
	};
	...
	k.al = function(a, b, c, d, e) {
		this.tileGrid ? (b = this.tileGrid.Le(a, b), iz(this.ad(b[0], b[1], b[2], 1, this.c), a, c, d, e)) : !0 === e ?
			setTimeout(function() {
				c.call(d, null)
			}, 0) : c.call(d, null)
	};
		...
		if (f) {
			...
			h.Vf(v, h.Dc(z), function(a) {
				var b = gb(v, h.Ma(a)),
					c = h.G();
				c && (b = gb(b, c));
				.5 <= cb(b) / z && .5 <= db(b) / z && (b = a.toString(), c = m[b], c || (c = g(a, n, p), c = m[b] = new q(a,
					void 0 == c ? 4 : 0, void 0 == c ? "" : c, d, e), this.N.push(y(c, "change", r))), c.c++, this.a.push(b))
			}.bind(this))
		}
	}
	w(pz, cl);
	...
	k.ad = function(a, b, c, d, e) {
		...
		a = [a, b, c];
		b = ky(this, a, e);
		d = new pz(a, null !== b ? 0 : 4, this.g, this.l, this.tileLoadFunction, b, this.tileUrlFunction, this.tileGrid,
			this.eb(e), this.i, d, e, this.tileClass, this.dj.bind(this), this.Ea);
		this.a.set(f, d);
		return d
	};
	k.eb = function(a) {
	...
	function vz(a) {
		...
		(b = a.url) && -1 == b.indexOf("{TileGroup}") && -1 == b.indexOf("{tileIndex}") && (b +=
			"{TileGroup}/{z}-{x}-{y}.jpg");
		b = Yx(b);
	...
	t("ol.render.toContext", function(a, b) {
		var c = a.canvas,
			d = b ? b : {};
		b = d.pixelRatio || nd;
		if (d = d.size) c.width = d[0] * b, c.height = d[1] * b, c.style.width = d[0] + "px", c.style.height = d[1] +
			"px";
	...
	t("ol.source.BingMaps.TOS_ATTRIBUTION",
		'<a class="ol-attribution-bing-tos" href="https://www.microsoft.com/maps/product/terms.html">Terms of Use</a>');
