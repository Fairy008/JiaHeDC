...
define(function(){
    ...
    var custom_settings = {
         ...
         * 公共的title配置
         */
        public_title:"高分数据共享管理系统",  //login.html 、main.html、index.html 都有配置 title 名称

        /**
         * login.html 相关 自定义设置
         */

        login_left_top_logo_pic:"images/public/logo2.png",  //login.html 左上角 公司logo (图片大小为：38*39)
         ...
         * main.html 相关 自定义设置
         */
        main_left_top_logo_pic:"images/public/logo2.png", //main.html 左上角 公司logo图片 (图片大小为：40*40)
        ...
        main_search_region_id:'3102000029',
        main_search_region_code:"CHN-LN",
        main_search_region_name:"中国 | 辽宁",
        main_search_beginTime:'2018-01-01',
