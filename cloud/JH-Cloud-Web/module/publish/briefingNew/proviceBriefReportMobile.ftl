...
<div class="myRightMain">
    <div>
        ...
        <span class="borderStyleDashed">物侯阶段：<span class="textSpan">${growthPeriodName!}</span></br>
            ...
            <#if trmmRise?? && trmmFall??>
                <span class="textSpan">${trmmRiseRegionName!}</span>比历史同期多 <span class="textSpan">${trmmRise!}</span>
                ，
                <span class="textSpan">${trmmFallRegionName!}</span>比历史同期少 <span class="textSpan">${trmmFall!}</span>
            <#else>
                <span class="textSpan">数据更新中</span>
            </#if>
	   </span></br>
